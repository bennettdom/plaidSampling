...
bool_or(merchantname = 'Quany') as Quany
  ...
  dimension: Walmart {
    type: yesno
    sql: ${TABLE}."Walmart" OR ${TABLE}."Wal-mart";;
  }
  ...
  dimension: 7Eleven {
    type: yesno
    sql: ${TABLE}."7-Eleven" OR ${TABLE}."7-eleven" OR ${TABLE}."7-11";;
  }
  ...
  dimension: Dollar_General {
    type: yesno
    sql: ${TABLE}."Dollar General";;
  }
  ...
  dimension: ChickfilA {
    type: yesno
    sql: ${TABLE}."Chick-fil-A" OR ${TABLE}."Chickfila" OR ${TABLE}."Chick-fil";;
  }

  dimension: Chickfila_App {
    type: yesno
    sql: ${TABLE}."Chickfila App";;
  }
  ...
  dimension: Family_Dollar {
    type: yesno
    sql: ${TABLE}."Family Dollar";;
  }
  ...
  dimension: Rent_A_Center {
    type: yesno
    sql: ${TABLE}."Rent-A-Center";;
  }
  ...
  dimension: Sony_Playstation {
    type: yesno
    sql: ${TABLE}."Sony Playstation";;
  }
  ...
  dimension: Wendys {
    type: yesno
    sql: ${TABLE}."Wendy''s" OR ${TABLE}."Wendys";;
  }
  ...
  dimension: H_E_B {
    type: yesno
    sql: ${TABLE}."H-E-B" OR ${TABLE}."H E B" OR ${TABLE}."H-e-b";;
  }
  ...
  dimension: Burger_King {
    type: yesno
    sql: ${TABLE}."Burger King";;
  }

  dimension: Enterprise_Rent_A_Car {
    type: yesno
    sql: ${TABLE}."Enterprise Rent-A-Car";;
  }
  ...
  dimension: Sams_Club {
    type: yesno
    sql: ${TABLE}."Sam''s Club";;
  }

  dimension: Ross_Stores {
    type: yesno
    sql: ${TABLE}."Ross Stores";;
  }
  ...
  dimension: Instacash_Re {
    type: yesno
    sql: ${TABLE}."Instacash Re";;
  }

  dimension: The_Home_Depot {
    type: yesno
    sql: ${TABLE}."The Home Depot";;
  }
  ...
  dimension: ExxonMobil {
    type: yesno
    sql: ${TABLE}."ExxonMobil";;
  }

  dimension: Chipotle_Mexican_Grill {
    type: yesno
    sql: ${TABLE}."Chipotle Mexican Grill";;
  }

  dimension: Draftkings {
    type: yesno
    sql: ${TABLE}."Draftkings";;
  }
  ...
  dimension: Ubr_Pending.uber {
    type: yesno
    sql: ${TABLE}."Ubr Pending.uber" OR ${TABLE}."Ubr Pending.uber." OR ${TABLE}."Ubr Pending.uber.co" OR ${TABLE}."Ubr Pending.uber.com";;
  }

  dimension: Marathon_Petroleum_Corporation {
    type: yesno
    sql: ${TABLE}."Marathon Petroleum Corporation";;
  }
  ...
  dimension: Instacash_Repaymen {
    type: yesno
    sql: ${TABLE}."Instacash Repaymen";;
  }

  dimension: Little_Caesars {
    type: yesno
    sql: ${TABLE}."Little Caesar''s";;
  }
  ...
  dimension: Lowes {
    type: yesno
    sql: ${TABLE}."Lowe''s" OR ${TABLE}."Lowes";;
  }
  ...
  dimension: Albertsons {
    type: yesno
    sql: ${TABLE}."Albertsons" OR ${TABLE}."Albertson''s";;
  }

  dimension: Jack_in_the_Box {
    type: yesno
    sql: ${TABLE}."Jack in the Box";;
  }

  dimension: Instacash_Repayme {
    type: yesno
    sql: ${TABLE}."Instacash Repayme";;
  }
  ...
  dimension: Papa_Johns {
    type: yesno
    sql: ${TABLE}."Papa John''s";;
  }
  ...
  dimension: Kohls {
    type: yesno
    sql: ${TABLE}."Kohl''s" OR ${TABLE}."Kohls";;
  }

  dimension: King_Soopers {
    type: yesno
    sql: ${TABLE}."King Soopers";;
  }
  ...
  dimension: Panda_Express {
    type: yesno
    sql: ${TABLE}."Panda Express";;
  }

  dimension: Army_and_Air_Force_Exchange_Service {
    type: yesno
    sql: ${TABLE}."Army & Air Force Exchange Service";;
  }
  ...
  dimension: Applebees {
    type: yesno
    sql: ${TABLE}."Applebee''s";;
  }

  dimension: American_Airlines {
    type: yesno
    sql: ${TABLE}."American Airlines";;
  }
  ...
  dimension: Whataburger {
    type: yesno
    sql: ${TABLE}."Whataburger";;
  }

  dimension: Burlington {
    type: yesno
    sql: ${TABLE}."Burlington";;
  }
  ...
  dimension: Whole_Foods {
    type: yesno
    sql: ${TABLE}."Whole Foods";;
  }

  dimension: Winco_Foods {
    type: yesno
    sql: ${TABLE}."Winco Foods";;
  }

  dimension: Winn_Dixie {
    type: yesno
    sql: ${TABLE}."Winn-Dixie";;
  }

  dimension: Panera_Bread {
    type: yesno
    sql: ${TABLE}."Panera Bread";;
  }
  ...
  dimension: Fred_Meyer {
    type: yesno
    sql: ${TABLE}."Fred Meyer";;
  }
  ...
  dimension: Klover_App_Boo {
    type: yesno
    sql: ${TABLE}."Klover App Boo";;
  }

  dimension: Trader_Joes {
    type: yesno
    sql: ${TABLE}."Trader Joe''s";;
  }

  dimension: Klover_Holdings {
    type: yesno
    sql: ${TABLE}."Klover Holdings";;
  }
  ...
  dimension: Spirit_Halloween {
    type: yesno
    sql: ${TABLE}."Spirit Halloween";;
  }
  ...
  dimension: Harris_Teeter_Supermarkets_Inc {
    type: yesno
    sql: ${TABLE}."Harris Teeter Supermarkets, Inc.";;
  }

  dimension: Bath_and_Body_Works {
    type: yesno
    sql: ${TABLE}."Bath & Body Works";;
  }

  dimension: Buffalo_Wild_Wings {
    type: yesno
    sql: ${TABLE}."Buffalo Wild Wings";;
  }
  ...
  dimension: Foot_Locker {
    type: yesno
    sql: ${TABLE}."Foot Locker";;
  }
  ...
  dimension: Olive_Garden {
    type: yesno
    sql: ${TABLE}."Olive Garden";;
  }

  dimension: Giant_Eagle {
    type: yesno
    sql: ${TABLE}."Giant Eagle";;
  }
  ...
  dimension: Dairy_Queen {
    type: yesno
    sql: ${TABLE}."Dairy Queen";;
  }
 ...
 dimension: Branch_Messe {
  type: yesno
  sql: ${TABLE}."Branch Messe";;
}

dimension: Apple_Cash {
  type: yesno
  sql: ${TABLE}."Apple Cash";;
}
...
dimension: Five_Below {
  type: yesno
  sql: ${TABLE}."Five Below";;
}
...
dimension: Texas_Roadhouse {
  type: yesno
  sql: ${TABLE}."Texas Roadhouse";;
}

dimension: Caseys_General_Store {
  type: yesno
  sql: ${TABLE}."Casey''s General Store";;
}
...
dimension: Flexshopper {
  type: yesno
  sql: ${TABLE}."Flexshopper";;
}

dimension: Item_Returned {
  type: yesno
  sql: ${TABLE}."Item Returned";;
}
...
dimension: Pymt_Sent_Apple_Cash {
  type: yesno
  sql: ${TABLE}."Pymt Sent Apple Cash";;
}

dimension: Party_City {
  type: yesno
  sql: ${TABLE}."Party City";;
}
...
dimension: Aarons {
  type: yesno
  sql: ${TABLE}."Aarons" OR ${TABLE}."Aaron''s";;
}
...
dimension: Academy_Sports_and_Outdoors {
  type: yesno
  sql: ${TABLE}."Academy Sports + Outdoors";;
}
...
dimension: Waffle_House {
  type: yesno
  sql: ${TABLE}."Waffle House";;
}
...
dimension: Planet_Fitness {
  type: yesno
  sql: ${TABLE}."Planet Fitness";;
}

dimension: Extendedstay {
  type: yesno
  sql: ${TABLE}."Extendedstay";;
}

dimension: Ubr_Pending {
  type: yesno
  sql: ${TABLE}."Ubr Pending";;
}
...
dimension: Wf_Wayfair {
  type: yesno
  sql: ${TABLE}."Wf Wayfair";;
}

dimension: Hobby_Lobby {
  type: yesno
  sql: ${TABLE}."Hobby Lobby";;
}

dimension: Champs_Sports {
  type: yesno
  sql: ${TABLE}."Champs Sports";;
}
...
dimension: Frys_Food_and_Drug {
  type: yesno
  sql: ${TABLE}."Fry''s Food and Drug";;
}

dimension: Dollar_Tree {
  type: yesno
  sql: ${TABLE}."Dollar Tree";;
}

dimension: Ktplt_wayfair {
  type: yesno
  sql: ${TABLE}."Ktplt-wayfair";;
}
...
dimension: Phillips_66 {
  type: yesno
  sql: ${TABLE}."Phillips 66";;
}
...
dimension: Fanduel_Betfair_Play {
  type: yesno
  sql: ${TABLE}."Fanduel Betfair Play";;
}

dimension: Murphy_USA {
  type: yesno
  sql: ${TABLE}."Murphy USA";;
}

dimension: Raising_Canes_Chicken_Fingers {
  type: yesno
  sql: ${TABLE}."Raising Cane''s Chicken Fingers";;
}

dimension: Jimmy_Johns {
  type: yesno
  sql: ${TABLE}."Jimmy John''s";;
}
...
dimension: Advance_Auto_Parts {
  type: yesno
  sql: ${TABLE}."Advance Auto Parts";;
}

dimension: Food_4_Less {
  type: yesno
  sql: ${TABLE}."Food 4 Less";;
}

dimension: Toyota_Financial {
  type: yesno
  sql: ${TABLE}."Toyota Financial";;
}
...
dimension: Kum_and_Go {
  type: yesno
  sql: ${TABLE}."Kum & Go";;
}

dimension: Holiday_Inn {
  type: yesno
  sql: ${TABLE}."Holiday Inn";;
}

dimension: Staterbros {
  type: yesno
  sql: ${TABLE}."Staterbros";;
}
...
dimension: Quadpay_Fashion {
  type: yesno
  sql: ${TABLE}."Quadpay Fashion";;
}

dimension: Loves_Travel_Stop {
  type: yesno
  sql: ${TABLE}."Love''s Travel Stop";;
}

dimension: Fashionnova {
  type: yesno
  sql: ${TABLE}."Fashionnova";;
}

dimension: Maverik_Convenience_Store {
  type: yesno
  sql: ${TABLE}."Maverik Convenience Store";;
}

dimension: Acceptancenow {
  type: yesno
  sql: ${TABLE}."Acceptancenow";;
}

dimension: Hy_Vee {
  type: yesno
  sql: ${TABLE}."Hy-Vee" OR ${TABLE}."Hy Vee";;
}

dimension: Navy_Exchange {
  type: yesno
  sql: ${TABLE}."Navy Exchange";;
}

dimension: Dunkin_Donuts {
  type: yesno
  sql: ${TABLE}."Dunkin'' Donuts";;
}

dimension: Acme_Markets {
  type: yesno
  sql: ${TABLE}."Acme Markets";;
}

dimension: Progressive_Leasing {
  type: yesno
  sql: ${TABLE}."Progressive Leasing";;
}
...
dimension: Cumberland_Farms {
  type: yesno
  sql: ${TABLE}."Cumberland Farms";;
}
...
dimension: Youtube_Tv {
  type: yesno
  sql: ${TABLE}."Youtube Tv";;
}
...
dimension: BJs_Wholesale_Club {
  type: yesno
  sql: ${TABLE}."BJ''s Wholesale Club";;
}

dimension: Royal_Farms {
  type: yesno
  sql: ${TABLE}."Royal Farms";;
}

dimension: Bojangles_Famous_Chicken_n_Biscuits {
  type: yesno
  sql: ${TABLE}."Bojangles'' Famous Chicken ''n Biscuits";;
}
...
dimension: Costco_Gas {
  type: yesno
  sql: ${TABLE}."Costco Gas";;
}
...
dimension: Save_A_Lot {
  type: yesno
  sql: ${TABLE}."Save-A-Lot";;
}
...
dimension: Chumba_Gold_Coins {
  type: yesno
  sql: ${TABLE}."Chumba Gold Coins";;
}

dimension: Smiths_Food_and_Drug {
  type: yesno
  sql: ${TABLE}."Smith''s Food and Drug";;
}

dimension: Planet_Fit_Club_Fees {
  type: yesno
  sql: ${TABLE}."Planet Fit Club Fees";;
}
...
dimension: In_N_Out_Burger {
  type: yesno
  sql: ${TABLE}."In-N-Out Burger";;
}

dimension: Outback_Steakhouse {
  type: yesno
  sql: ${TABLE}."Outback Steakhouse";;
}

dimension: Forever_21 {
  type: yesno
  sql: ${TABLE}."Forever 21";;
}
...
dimension: Total_Wine_and_More {
  type: yesno
  sql: ${TABLE}."Total Wine & More";;
}
...
dimension: Delta_Air_Lines {
  type: yesno
  sql: ${TABLE}."Delta Air Lines";;
}
...
dimension: Holiday_Stations_Stores {
  type: yesno
  sql: ${TABLE}."Holiday Stations Stores";;
}
...
dimension: Spirit_Airl {
  type: yesno
  sql: ${TABLE}."Spirit Airl";;
}

dimension: Victorias_Secret {
  type: yesno
  sql: ${TABLE}."Victoria''s Secret";;
}

dimension: Chumba_Gold {
  type: yesno
  sql: ${TABLE}."Chumba Gold";;
}
...
dimension: Weis_Markets {
  type: yesno
  sql: ${TABLE}."Weis Markets";;
}

dimension: William_Hill_Sport {
  type: yesno
  sql: ${TABLE}."William Hill Sport";;
}
...
dimension: LongHorn_Steakhouse {
  type: yesno
  sql: ${TABLE}."LongHorn Steakhouse";;
}
...
dimension: Quadpay_Anywh {
  type: yesno
  sql: ${TABLE}."Quadpay Anywh";;
}

dimension: Tractor_Supply {
  type: yesno
  sql: ${TABLE}."Tractor Supply";;
}

dimension: Red_Lobster {
  type: yesno
  sql: ${TABLE}."Red Lobster";;
}
...
dimension: Aarons_Ezpay {
  type: yesno
  sql: ${TABLE}."Aarons Ezpay";;
}
...
dimension: Jersey_Mikes_Subs {
  type: yesno
  sql: ${TABLE}."Jersey Mike''s Subs";;
}

dimension: K_VA_T_Food_City {
  type: yesno
  sql: ${TABLE}."K-VA-T Food City";;
}
...
dimension: Exeter_Autorec {
  type: yesno
  sql: ${TABLE}."Exeter Autorec";;
}

dimension: Best_Western {
  type: yesno
  sql: ${TABLE}."Best Western";;
}

dimension: Sprouts_Farmers_Market {
  type: yesno
  sql: ${TABLE}."Sprouts Farmers Market";;
}

dimension: Steam_Games {
  type: yesno
  sql: ${TABLE}."Steam Games";;
}

dimension: Draftkings_Inc {
  type: yesno
  sql: ${TABLE}."Draftkings Inc";;
}

dimension: Citi_Trends {
  type: yesno
  sql: ${TABLE}."Citi Trends";;
}
...
dimension: Draftkings_I {
  type: yesno
  sql: ${TABLE}."Draftkings I";;
}

dimension: Quadpay {
  type: yesno
  sql: ${TABLE}."Quadpay" OR ${TABLE}."Quadpay Quadpa" OR ${TABLE}."Quadpay Quadpay A" OR ${TABLE}."Quadpay Quadpay Anywh" OR ${TABLE}."Quadpay Qua";;
}

dimension: Finish_Line {
  type: yesno
  sql: ${TABLE}."Finish Line";;
}

dimension: Scentsy_Inc {
  type: yesno
  sql: ${TABLE}."Scentsy Inc.";;
}
...
dimension: Hibbett_Sports {
  type: yesno
  sql: ${TABLE}."Hibbett Sports";;
}

dimension: Wm_Superc_Wa {
  type: yesno
  sql: ${TABLE}."Wm Superc Wa";;
}

dimension: Red_Roof_Inn {
  type: yesno
  sql: ${TABLE}."Red Roof Inn";;
}
...
dimension: AliExpress {
  type: yesno
  sql: ${TABLE}."AliExpress";;
}
...
dimension: Market_Basket {
  type: yesno
  sql: ${TABLE}."Market Basket";;
}

dimension: Checkers_and_Rallys {
  type: yesno
  sql: ${TABLE}."Checkers and Rally''s";;
}

dimension: Fingerhut_Payments {
  type: yesno
  sql: ${TABLE}."Fingerhut Payments";;
}

dimension: Bestbuycom {
  type: yesno
  sql: ${TABLE}."Bestbuycom";;
}
...
dimension: United_Dairy_Farmers {
  type: yesno
  sql: ${TABLE}."United Dairy Farmers";;
}
...
dimension: Grain_Technology {
  type: yesno
  sql: ${TABLE}."Grain Technology";;
}

dimension: Sugarhouse_Betrivers {
  type: yesno
  sql: ${TABLE}."Sugarhouse Betrivers";;
}

dimension: Spdpy_American {
  type: yesno
  sql: ${TABLE}."Spdpy American";;
}
...
dimension: Piggly_Wiggly {
  type: yesno
  sql: ${TABLE}."Piggly Wiggly";;
}

dimension: Marcos_Pizza {
  type: yesno
  sql: ${TABLE}."Marco''s Pizza";;
}
...
dimension: Cracker_Barrel {
  type: yesno
  sql: ${TABLE}."Cracker Barrel";;
}
...
dimension: Microsoft_Ultimate {
  type: yesno
  sql: ${TABLE}."Microsoft Ultimate";;
}
...
dimension: Tvg_online {
  type: yesno
  sql: ${TABLE}."Tvg-online";;
}
...
dimension: Chumba_Gold_Coins_Valetta {
  type: yesno
  sql: ${TABLE}."Chumba Gold Coins Valetta";;
}

dimension: Harbor_Freight_Tools {
  type: yesno
  sql: ${TABLE}."Harbor Freight Tools";;
}
...
dimension: TGI_Fridays {
  type: yesno
  sql: ${TABLE}."TGI Friday''s";;
}

dimension: Spdpy_American_Cre {
  type: yesno
  sql: ${TABLE}."Spdpy American Cre";;
}
...
dimension: Hyatt_Resorts {
  type: yesno
  sql: ${TABLE}."Hyatt Resorts";;
}

dimension: White_Castle {
  type: yesno
  sql: ${TABLE}."White Castle";;
}
...
dimension: MarketAtwork {
  type: yesno
  sql: ${TABLE}."Market@work";;
}
...
dimension: Bed_Bath_and_Beyond {
  type: yesno
  sql: ${TABLE}."Bed Bath & Beyond";;
}

dimension: Market_Street {
  type: yesno
  sql: ${TABLE}."Market Street";;
}
...
dimension: Cof_Merchnt_Bil {
  type: yesno
  sql: ${TABLE}."Cof Merchnt Bil";;
}
...
dimension: Shoe_Carnival {
  type: yesno
  sql: ${TABLE}."Shoe Carnival";;
}
...
dimension: Quadpay_Fashion_Nova {
  type: yesno
  sql: ${TABLE}."Quadpay Fashion Nova";;
}
...
dimension: Price_Chopper_Supermarkets {
  type: yesno
  sql: ${TABLE}."Price Chopper Supermarkets";;
}
...
dimension: Pilot_Flying_J {
  type: yesno
  sql: ${TABLE}."Pilot Flying J";;
}

dimension: DoubleTree {
  type: yesno
  sql: ${TABLE}."DoubleTree";;
}

dimension: Frontier_Ai {
  type: yesno
  sql: ${TABLE}."Frontier Ai";;
}

dimension: Smiledirectclub {
  type: yesno
  sql: ${TABLE}."Smiledirectclub";;
}

dimension: Fanduel_Inc {
  type: yesno
  sql: ${TABLE}."Fanduel Inc";;
}
...
dimension: Barnes_and_Noble {
  type: yesno
  sql: ${TABLE}."Barnes & Noble";;
}

dimension: Fred_meye_Fred {
  type: yesno
  sql: ${TABLE}."Fred-meye Fred";;
}

dimension: Ford_Motor_Cr_Fordcredit {
  type: yesno
  sql: ${TABLE}."Ford Motor Cr Fordcredit";;
}
...
dimension: Aarons_Salo {
  type: yesno
  sql: ${TABLE}."Aarons Salo";;
}
...
dimension: Krispy_Kreme {
  type: yesno
  sql: ${TABLE}."Krispy Kreme";;
}

dimension: Jo_Ann_Stores {
  type: yesno
  sql: ${TABLE}."Jo-Ann Stores";;
}

dimension: Sportsmans_Guide {
  type: yesno
  sql: ${TABLE}."Sportsmans Guide";;
}

dimension: Va_Abc_Store {
  type: yesno
  sql: ${TABLE}."Va Abc Store";;
}

dimension: Sally_Beauty {
  type: yesno
  sql: ${TABLE}."Sally Beauty";;
}

dimension: Dillards {
  type: yesno
  sql: ${TABLE}."Dillard''s" OR ${TABLE}."Dillards";;
}
...
dimension: Hilton_Hotels_and_Resorts {
  type: yesno
  sql: ${TABLE}."Hilton Hotels & Resorts";;
}

dimension: Nst_The_Home_D {
  type: yesno
  sql: ${TABLE}."Nst The Home D";;
}
...
dimension: Michael_Kors {
  type: yesno
  sql: ${TABLE}."Michael Kors";;
}

dimension: Instacash_Repay {
  type: yesno
  sql: ${TABLE}."Instacash Repay";;
}

dimension: Steak_n_Shake {
  type: yesno
  sql: ${TABLE}."Steak ''n Shake";;
}
...
dimension: Smart_and_Final {
  type: yesno
  sql: ${TABLE}."Smart and Final";;
}
...
dimension: Skillz_Esports {
  type: yesno
  sql: ${TABLE}."Skillz Esports";;
}

dimension: Albert_Instant {
  type: yesno
  sql: ${TABLE}."Albert Instant";;
}
...
dimension: Tropical_Smoothie_Cafe {
  type: yesno
  sql: ${TABLE}."Tropical Smoothie Cafe";;
}

dimension: Grocery_Outlet {
  type: yesno
  sql: ${TABLE}."Grocery Outlet";;
}

dimension: Wm_Supercenter {
  type: yesno
  sql: ${TABLE}."Wm Supercenter";;
}
...
dimension: Firehouse_Subs {
  type: yesno
  sql: ${TABLE}."Firehouse Subs";;
}

dimension: Pybridgecrest {
  type: yesno
  sql: ${TABLE}."Pybridgecrest";;
}
...
dimension: Flash_Foods {
  type: yesno
  sql: ${TABLE}."Flash Foods";;
}

dimension: PayByPhone {
  type: yesno
  sql: ${TABLE}."PayByPhone";;
}

dimension: Rent_A_Tire {
  type: yesno
  sql: ${TABLE}."Rent A Tire";;
}
...
dimension: Texas_Toyota {
  type: yesno
  sql: ${TABLE}."Texas Toyota";;
}

dimension: American_Eagle {
  type: yesno
  sql: ${TABLE}."American Eagle";;
}
...
dimension: Wal_mart_Super_Center {
  type: yesno
  sql: ${TABLE}."Wal-mart Super Center";;
}
...
dimension: Turkey_Hill {
  type: yesno
  sql: ${TABLE}."Turkey Hill";;
}

dimension: La_Fitness {
  type: yesno
  sql: ${TABLE}."La Fitness";;
}

dimension: Cactus_Jacks {
  type: yesno
  sql: ${TABLE}."Cactus Jacks";;
}

dimension: Mta_Metrocard_Machine {
  type: yesno
  sql: ${TABLE}."Mta Metrocard Machine";;
}
...
dimension: Evi_Pechanga_Res {
  type: yesno
  sql: ${TABLE}."Evi Pechanga Res";;
}

dimension: Stewarts_Shops {
  type: yesno
  sql: ${TABLE}."Stewart''s Shops";;
}

dimension: Smoothie_King {
  type: yesno
  sql: ${TABLE}."Smoothie King";;
}

dimension: Tim_Hortons {
  type: yesno
  sql: ${TABLE}."Tim Hortons";;
}

dimension: Pca_Riverwalk_Hotel {
  type: yesno
  sql: ${TABLE}."Pca Riverwalk Hotel";;
}

dimension: DDs_Discounts {
  type: yesno
  sql: ${TABLE}."DD''s Discounts";;
}
...
dimension: Direct_Auto {
  type: yesno
  sql: ${TABLE}."Direct Auto";;
}
...
dimension: Fanduel_Betfair {
  type: yesno
  sql: ${TABLE}."Fanduel Betfair";;
}

dimension: Jimmy_Jazz {
  type: yesno
  sql: ${TABLE}."Jimmy Jazz";;
}

dimension: Guitar_Center {
  type: yesno
  sql: ${TABLE}."Guitar Center";;
}

dimension: Kmf_Kmfusa {
  type: yesno
  sql: ${TABLE}."Kmf Kmfusa";;
}

dimension: Specs_Wine_Spirits_and_Finer_Foods {
  type: yesno
  sql: ${TABLE}."Spec''s Wine, Spirits & Finer Foods";;
}

dimension: Wine_And_Spirits {
  type: yesno
  sql: ${TABLE}."Wine And Spirits";;
}

dimension: Brightlending {
  type: yesno
  sql: ${TABLE}."Brightlending";;
}

dimension: 99_Cents_Only_Stores {
  type: yesno
  sql: ${TABLE}."99 Cents Only Stores";;
}

dimension: Borgataonline {
  type: yesno
  sql: ${TABLE}."Borgataonline";;
}
...
dimension: American_Fnd {
  type: yesno
  sql: ${TABLE}."American Fnd";;
}
...
dimension: Budget_Car_Rental {
  type: yesno
  sql: ${TABLE}."Budget Car Rental";;
}
...
dimension: Yard_House {
  type: yesno
  sql: ${TABLE}."Yard House";;
}
...
dimension: Bnkofgeorge_unibet_Play {
  type: yesno
  sql: ${TABLE}."Bnkofgeorge-unibet Play";;
}

dimension: Ollies_Bargain_Outlet {
  type: yesno
  sql: ${TABLE}."Ollie''s Bargain Outlet";;
}

dimension: Key_Food_Stores_Co_op_Inc {
  type: yesno
  sql: ${TABLE}."Key Food Stores Co-op, Inc.";;
}

dimension: Exeter_Auto {
  type: yesno
  sql: ${TABLE}."Exeter Auto";;
}
...
dimension: Platos_Closet {
  type: yesno
  sql: ${TABLE}."Plato''s Closet";;
}

dimension: Playsugarhousepa {
  type: yesno
  sql: ${TABLE}."Playsugarhousepa";;
}
...
dimension: The_Childrens_Place {
  type: yesno
  sql: ${TABLE}."The Childrens Place";;
}

dimension: Bath_And_Body {
  type: yesno
  sql: ${TABLE}."Bath And Body";;
}

dimension: Diamond_Shamrock {
  type: yesno
  sql: ${TABLE}."Diamond Shamrock";;
}
...
dimension: El_Pollo_Loco {
  type: yesno
  sql: ${TABLE}."El Pollo Loco";;
}
...
dimension: Pay_With_Barther {
  type: yesno
  sql: ${TABLE}."Pay With Barther";;
}

dimension: Woodcliff_Bp_Gas {
  type: yesno
  sql: ${TABLE}."Woodcliff Bp Gas";;
}
...
dimension: Ibi_Savagexfenty {
  type: yesno
  sql: ${TABLE}."Ibi Savagexfenty";;
}

dimension: Verizonwrlss_Rtccr_Ve {
  type: yesno
  sql: ${TABLE}."Verizonwrlss Rtccr Ve";;
}

dimension: Burlington_Sto {
  type: yesno
  sql: ${TABLE}."Burlington Sto" OR ${TABLE}."Burlington Stor";;
}

dimension: Betmgm_Play {
  type: yesno
  sql: ${TABLE}."Betmgm Play";;
}
...
dimension: OReilly_Auto_Parts {
  type: yesno
  sql: ${TABLE}."O''Reilly Auto Parts";;
}
...
dimension: Deckers_Ugg {
  type: yesno
  sql: ${TABLE}."Deckers Ugg";;
}
...
dimension: Mco_Gibraltar {
  type: yesno
  sql: ${TABLE}."Mco Gibraltar";;
}

dimension: Color_Street_LLC {
  type: yesno
  sql: ${TABLE}."Color Street LLC";;
}

dimension: Shake_Shack {
  type: yesno
  sql: ${TABLE}."Shake Shack";;
}

dimension: United_Pacific {
  type: yesno
  sql: ${TABLE}."United Pacific";;
}

dimension: Mavis_Tire {
  type: yesno
  sql: ${TABLE}."Mavis Tire";;
}

dimension: Bnkofgeorge {
  type: yesno
  sql: ${TABLE}."Bnkofgeorge-";;
}

dimension: West_Creek {
  type: yesno
  sql: ${TABLE}."West Creek";;
}
...
dimension: Pacific_Sunwear {
  type: yesno
  sql: ${TABLE}."Pacific Sunwear";;
}

dimension: Footaction {
  type: yesno
  sql: ${TABLE}."Footaction";;
}

dimension: Texas_Rv_Outlet {
  type: yesno
  sql: ${TABLE}."Texas Rv Outlet";;
}
...
dimension: Fashionnova.c {
  type: yesno
  sql: ${TABLE}."Fashionnova.c";;
}
...
dimension: Freddys_Frozen_Custard_and_Steakburgers {
  type: yesno
  sql: ${TABLE}."Freddy''s Frozen Custard & Steakburgers";;
}
...
dimension: Caesars_Hotel_and_Casino {
  type: yesno
  sql: ${TABLE}."Caesars Hotel & Casino";;
}

dimension: Frys_Food_and_Drug_Fuel {
  type: yesno
  sql: ${TABLE}."Fry''s Food and Drug Fuel";;
}

dimension: Total_Card_Inc {
  type: yesno
  sql: ${TABLE}."Total Card Inc." OR ${TABLE}."Total Card Inc";;
}

dimension: Stitch_Fix_Inc {
  type: yesno
  sql: ${TABLE}."Stitch Fix Inc.";;
}

dimension: Cash_Centra {
  type: yesno
  sql: ${TABLE}."Cash Centra";;
}

dimension: Stater_Bros._Markets {
  type: yesno
  sql: ${TABLE}."Stater Bros. Markets";;
}
...
dimension: Wm_Superce {
  type: yesno
  sql: ${TABLE}."Wm Superce";;
}

dimension: Nissan_Motor {
  type: yesno
  sql: ${TABLE}."Nissan Motor";;
}

dimension: La_Quinta_Inns {
  type: yesno
  sql: ${TABLE}."La Quinta Inns";;
}

dimension: Papaya_Gaming {
  type: yesno
  sql: ${TABLE}."Papaya Gaming";;
}
...
dimension: Advance_Auto_P {
  type: yesno
  sql: ${TABLE}."Advance Auto P";;
}
...
dimension: Churchill_Downs {
  type: yesno
  sql: ${TABLE}."Churchill Downs";;
}
...
dimension: Amazon_Kindle {
  type: yesno
  sql: ${TABLE}."Amazon Kindle";;
}

dimension: Globalpok_Gold {
  type: yesno
  sql: ${TABLE}."Globalpok Gold";;
}

dimension: Dave_and_Busters {
  type: yesno
  sql: ${TABLE}."Dave & Busters";;
}

dimension: Quality_Inn {
  type: yesno
  sql: ${TABLE}."Quality Inn";;
}
...
dimension: Dutch_Bros._Coffee {
  type: yesno
  sql: ${TABLE}."Dutch Bros. Coffee";;
}

dimension: Jamba_Juice {
  type: yesno
  sql: ${TABLE}."Jamba Juice";;
}
...
dimension: Dds_Discount {
  type: yesno
  sql: ${TABLE}."Dd''s Discount";;
}
...
dimension: Fiesta_Mart {
  type: yesno
  sql: ${TABLE}."Fiesta Mart";;
}
...
dimension: Food_Depot {
  type: yesno
  sql: ${TABLE}."Food Depot";;
}

dimension: Usa_Snack_Soda_Vending {
  type: yesno
  sql: ${TABLE}."Usa Snack Soda Vending";;
}
...
dimension: Blizzard_Entertainment {
  type: yesno
  sql: ${TABLE}."Blizzard Entertainment";;
}
...
dimension: Aeropostale {
  type: yesno
  sql: ${TABLE}."Aeropostale";;
}

dimension: Spdpy_Toyota {
  type: yesno
  sql: ${TABLE}."Spdpy Toyota";;
}
...
dimension: Woodspring_Suites {
  type: yesno
  sql: ${TABLE}."Woodspring Suites";;
}
...
dimension: Chicken_Express {
  type: yesno
  sql: ${TABLE}."Chicken Express";;
}
...
dimension: Office_Depot {
  type: yesno
  sql: ${TABLE}."Office Depot";;
}
...
dimension: Pet_Supplies_Plus {
  type: yesno
  sql: ${TABLE}."Pet Supplies Plus";;
}

dimension: Golden_Chick {
  type: yesno
  sql: ${TABLE}."Golden Chick";;
}

dimension: Tiger_Mart {
  type: yesno
  sql: ${TABLE}."Tiger Mart";;
}

dimension: Walmart_Grocery {
  type: yesno
  sql: ${TABLE}."Walmart Grocery";;
}

dimension: Dicks_Sporting_Goods {
  type: yesno
  sql: ${TABLE}."Dick''s Sporting Goods" OR ${TABLE}."Dicks Sporting Goods" OR ${TABLE}."Dick''s Sportin" OR ${TABLE}."Dicks Sporting";;
}

dimension: Captain_Ds {
  type: yesno
  sql: ${TABLE}."Captain D''s";;
}

dimension: Duane_Reade {
  type: yesno
  sql: ${TABLE}."Duane Reade";;
}

dimension: Pick_n_Save {
  type: yesno
  sql: ${TABLE}."Pick ''n Save";;
}

dimension: Cash_Store {
  type: yesno
  sql: ${TABLE}."Cash Store";;
}
...
dimension: Groupon_Inc {
  type: yesno
  sql: ${TABLE}."Groupon Inc.";;
}

dimension: Brookshire_Grocery_Company {
  type: yesno
  sql: ${TABLE}."Brookshire Grocery Company";;
}

dimension: Victoriassecret {
  type: yesno
  sql: ${TABLE}."Victoriassecret";;
}

dimension: Bobs_Discount_Online {
  type: yesno
  sql: ${TABLE}."Bob''s Discount Online";;
}

dimension: Opc_Westlake {
  type: yesno
  sql: ${TABLE}."Opc Westlake";;
}

dimension: Carfinance {
  type: yesno
  sql: ${TABLE}."Carfinance";;
}
...
dimension: Cof_Merchnt {
  type: yesno
  sql: ${TABLE}."Cof Merchnt";;
}

dimension: Markosian_Auto {
  type: yesno
  sql: ${TABLE}."Markosian Auto";;
}

dimension: Taco_Cabana {
  type: yesno
  sql: ${TABLE}."Taco Cabana";;
}

dimension: Cash_Store_Tx {
  type: yesno
  sql: ${TABLE}."Cash Store Tx";;
}
...
dimension: Moon_Active {
  type: yesno
  sql: ${TABLE}."Moon Active";;
}
...
dimension: Michaels_Store {
  type: yesno
  sql: ${TABLE}."Michaels Store";;
}

dimension: Family_Dolla {
  type: yesno
  sql: ${TABLE}."Family Dolla";;
}
...
dimension: Shell_Service_Station {
  type: yesno
  sql: ${TABLE}."Shell Service Station";;
}

dimension: Hungry_Howies {
  type: yesno
  sql: ${TABLE}."Hungry Howies";;
}

dimension: Mellow_Mood {
  type: yesno
  sql: ${TABLE}."Mellow Mood";;
}

dimension: Planet_Fit {
  type: yesno
  sql: ${TABLE}."Planet Fit";;
}

dimension: Smoke_Shop {
  type: yesno
  sql: ${TABLE}."Smoke Shop";;
}
...
dimension: Tops_Friendly_Markets {
  type: yesno
  sql: ${TABLE}."Tops Friendly Markets";;
}

dimension: Raleys_Supermarket {
  type: yesno
  sql: ${TABLE}."Raley''s Supermarket";;
}

dimension: Nikepos_us {
  type: yesno
  sql: ${TABLE}."Nikepos_us";;
}
...
dimension: Alaska_Air {
  type: yesno
  sql: ${TABLE}."Alaska Air";;
}

dimension: Chegg_Order {
  type: yesno
  sql: ${TABLE}."Chegg Order";;
}

dimension: Bark_and_co {
  type: yesno
  sql: ${TABLE}."Bark&co";;
}
...
dimension: Ualett_Cabicash {
  type: yesno
  sql: ${TABLE}."Ualett Cabicash";;
}
...
dimension: Free_Drinks {
  type: yesno
  sql: ${TABLE}."Free Drinks";;
}
...
dimension: Bmw_Financialservi {
  type: yesno
  sql: ${TABLE}."Bmw Financialservi";;
}
...
dimension: Sunpass_Acc {
  type: yesno
  sql: ${TABLE}."Sunpass Acc";;
}

dimension: Bnkofgeorge_unib {
  type: yesno
  sql: ${TABLE}."Bnkofgeorge-unib";;
}

dimension: American_Credi {
  type: yesno
  sql: ${TABLE}."American Credi";;
}
...
dimension: Tutor_Time {
  type: yesno
  sql: ${TABLE}."Tutor Time";;
}

dimension: Hampton_Inns {
  type: yesno
  sql: ${TABLE}."Hampton Inns";;
}
...
dimension: Adore_Me_Inc {
  type: yesno
  sql: ${TABLE}."Adore Me Inc";;
}

dimension: Mta_Nyct_Paygo {
  type: yesno
  sql: ${TABLE}."Mta Nyct Paygo";;
}

dimension: Home_Depot {
  type: yesno
  sql: ${TABLE}."Home Depot";;
}

dimension: P.F_Changs {
  type: yesno
  sql: ${TABLE}."P.F. Chang''s";;
}

dimension: Bjs_Restaurants {
  type: yesno
  sql: ${TABLE}."Bjs Restaurants" OR ${TABLE}."Bj''s Restaurants";;
}

dimension: Golden_Corral {
  type: yesno
  sql: ${TABLE}."Golden Corral";;
}
...
dimension: Chacon_Autos {
  type: yesno
  sql: ${TABLE}."Chacon Autos";;
}
...
dimension: Uberat_eats {
  type: yesno
  sql: ${TABLE}."Uberat_eats";;
}

dimension: Plaid_Pantry {
  type: yesno
  sql: ${TABLE}."Plaid Pantry";;
}
...
dimension: Chuck_E_Cheese {
  type: yesno
  sql: ${TABLE}."Chuck E Cheese";;
}

dimension: Community_Credit {
  type: yesno
  sql: ${TABLE}."Community Credit";;
}
...
dimension: Quadpay_Fashion_N_Httpswww.quad_Ny {
  type: yesno
  sql: ${TABLE}."Quadpay Fashion N Httpswww.quad Ny";;
}
...
dimension: Penske_Trk_Lsg {
  type: yesno
  sql: ${TABLE}."Penske Trk Lsg";;
}

dimension: Corner_Store {
  type: yesno
  sql: ${TABLE}."Corner Store";;
}
...
dimension: Homewood_Suites {
  type: yesno
  sql: ${TABLE}."Homewood Suites";;
}

dimension: United_Auto {
  type: yesno
  sql: ${TABLE}."United Auto";;
}

dimension: Victorias_Sec {
  type: yesno
  sql: ${TABLE}."Victoria''s Sec";;
}
...
dimension: Wienerschnitzel {
  type: yesno
  sql: ${TABLE}."Wienerschnitzel";;
}
...
dimension: Cold_Stone_Creamery {
  type: yesno
  sql: ${TABLE}."Cold Stone Creamery";;
}

dimension: Exete_Autorec {
  type: yesno
  sql: ${TABLE}."Exete Autorec";;
}

dimension: Gabriel_Bros {
  type: yesno
  sql: ${TABLE}."Gabriel Bros";;
}
...
dimension: First_Watch {
  type: yesno
  sql: ${TABLE}."First Watch";;
}

dimension: Paparazzi_LLC {
  type: yesno
  sql: ${TABLE}."Paparazzi LLC";;
}

dimension: Cheesecake {
  type: yesno
  sql: ${TABLE}."Cheesecake";;
}
...
dimension: Sbd_Scentbird {
  type: yesno
  sql: ${TABLE}."Sbd Scentbird";;
}

dimension: Spirit_Air {
  type: yesno
  sql: ${TABLE}."Spirit Air";;
}

dimension: Advfinancial {
  type: yesno
  sql: ${TABLE}."Advfinancial";;
}
...
dimension: Vitamin_Shoppe {
  type: yesno
  sql: ${TABLE}."Vitamin Shoppe";;
}

dimension: The_Mens_Wearhouse {
  type: yesno
  sql: ${TABLE}."The Mens Wearhouse";;
}

dimension: Quick_Stop {
  type: yesno
  sql: ${TABLE}."Quick Stop";;
}
...
dimension: Giant_Food_Inc {
  type: yesno
  sql: ${TABLE}."Giant Food Inc";;
}

dimension: Heb_Online {
  type: yesno
  sql: ${TABLE}."Heb Online";;
}

dimension: Steam_Purchase {
  type: yesno
  sql: ${TABLE}."Steam Purchase";;
}

dimension: Toyota_Pay_Tfs {
  type: yesno
  sql: ${TABLE}."Toyota Pay Tfs";;
}

dimension: Wing_Tel_Inc {
  type: yesno
  sql: ${TABLE}."Wing Tel Inc.";;
}
...
dimension: Sli_stn_Prepaid {
  type: yesno
  sql: ${TABLE}."Sli-stn Prepaid";;
}

dimension: Davids_Bridal {
  type: yesno
  sql: ${TABLE}."Davids Bridal";;
}

dimension: Credit_Fresh {
  type: yesno
  sql: ${TABLE}."Credit Fresh";;
}

dimension: At_Home_Store {
  type: yesno
  sql: ${TABLE}."At Home Store";;
}

dimension: Mattress_Firm {
  type: yesno
  sql: ${TABLE}."Mattress Firm";;
}
...
dimension: Checkfreepay {
  type: yesno
  sql: ${TABLE}."Checkfreepay";;
}

dimension: Country_Inn {
  type: yesno
  sql: ${TABLE}."Country Inn";;
}
...
dimension: United_Auto_Credit {
  type: yesno
  sql: ${TABLE}."United Auto Credit";;
}

dimension: Furniture_And_C {
  type: yesno
  sql: ${TABLE}."Furniture And C";;
}

dimension: Ysi_The_Park_Ii {
  type: yesno
  sql: ${TABLE}."Ysi The Park Ii";;
}

dimension: Verizonwrlss_Rtccr {
  type: yesno
  sql: ${TABLE}."Verizonwrlss Rtccr";;
}

dimension: Fred_Meyer_Fuel_Center {
  type: yesno
  sql: ${TABLE}."Fred Meyer Fuel Center";;
}

dimension: Sprouts_Farmer {
  type: yesno
  sql: ${TABLE}."Sprouts Farmer";;
}

dimension: Jets_Pizza {
  type: yesno
  sql: ${TABLE}."Jet''s Pizza";;
}
...
dimension: Sherwin_Williams {
  type: yesno
  sql: ${TABLE}."Sherwin-Williams";;
}

dimension: Prime_Acura {
  type: yesno
  sql: ${TABLE}."Prime Acura";;
}

dimension: Vet_Scout_LLC {
  type: yesno
  sql: ${TABLE}."Vet Scout LLC";;
}

dimension: Helena_Robinson {
  type: yesno
  sql: ${TABLE}."Helena Robinson";;
}

dimension: Lemonade_I {
  type: yesno
  sql: ${TABLE}."Lemonade I";;
}

dimension: Residence_Inn {
  type: yesno
  sql: ${TABLE}."Residence Inn";;
}
...
dimension: The_Disney_Store {
  type: yesno
  sql: ${TABLE}."The Disney Store";;
}

dimension: American_Deli {
  type: yesno
  sql: ${TABLE}."American Deli";;
}

dimension: Newegg_Inc {
  type: yesno
  sql: ${TABLE}."Newegg Inc";;
}
...
dimension: Famous_Footwear {
  type: yesno
  sql: ${TABLE}."Famous Footwear";;
}

dimension: Loaf_N_Jug {
  type: yesno
  sql: ${TABLE}."Loaf ''N Jug";;
}
...
dimension: Genesis_Fs_Card {
  type: yesno
  sql: ${TABLE}."Genesis Fs Card";;
}

dimension: Express_Mart {
  type: yesno
  sql: ${TABLE}."Express Mart";;
}
...
dimension: Tim_Beck_Rentals {
  type: yesno
  sql: ${TABLE}."Tim Beck Rentals";;
}
...
dimension: LAZ_Parking {
  type: yesno
  sql: ${TABLE}."LAZ Parking";;
}

dimension: Aarons_Revrun {
  type: yesno
  sql: ${TABLE}."Aarons Revrun";;
}

dimension: Honeyman_Hardwar {
  type: yesno
  sql: ${TABLE}."Honeyman Hardwar";;
}

dimension: Spirit_Hallo {
  type: yesno
  sql: ${TABLE}."Spirit Hallo";;
}
...
dimension: Allsups_Convenience_Stores {
  type: yesno
  sql: ${TABLE}."Allsup''s Convenience Stores";;
}

dimension: Youtubepremium {
  type: yesno
  sql: ${TABLE}."Youtubepremium";;
}
...
dimension: Ollies_Bargain {
  type: yesno
  sql: ${TABLE}."Ollies Bargain";;
}

dimension: Crowne_Plaza {
  type: yesno
  sql: ${TABLE}."Crowne Plaza";;
}
...
dimension: Yokes_Fresh_Ma {
  type: yesno
  sql: ${TABLE}."Yoke''s Fresh Ma";;
}

dimension: American_Musical_Suppl {
  type: yesno
  sql: ${TABLE}."American Musical Suppl";;
}
...
dimension: Mcdonald_S {
  type: yesno
  sql: ${TABLE}."Mcdonald S";;
}

dimension: Once_Upon_A_Chld {
  type: yesno
  sql: ${TABLE}."Once Upon A Chld";;
}
...
dimension: Foxbet_Stars {
  type: yesno
  sql: ${TABLE}."Foxbet Stars";;
}
...
dimension: Mike_Carlson_Motor_Co {
  type: yesno
  sql: ${TABLE}."Mike Carlson Motor Co";;
}
...
dimension: Springhill_Suites {
  type: yesno
  sql: ${TABLE}."Springhill Suites";;
}
...
dimension: Farmers_Furniture {
  type: yesno
  sql: ${TABLE}."Farmers Furniture";;
}

dimension: Ysi_Polo_Glen {
  type: yesno
  sql: ${TABLE}."Ysi Polo Glen";;
}
...
dimension: Valetta_Mlt {
  type: yesno
  sql: ${TABLE}."Valetta Mlt";;
}

dimension: Credit_Accep {
  type: yesno
  sql: ${TABLE}."Credit Accep";;
}

dimension: Sutton_Bank_parx_Play {
  type: yesno
  sql: ${TABLE}."Sutton Bank-parx Play";;
}

dimension: Baskin_Robbins {
  type: yesno
  sql: ${TABLE}."Baskin-Robbins";;
}

dimension: United_Express {
  type: yesno
  sql: ${TABLE}."United Express";;
}

dimension: Evergy_Metro {
  type: yesno
  sql: ${TABLE}."Evergy Metro";;
}
...
dimension: Amc_Online {
  type: yesno
  sql: ${TABLE}."Amc Online";;
}

dimension: Donatos_Pizza {
  type: yesno
  sql: ${TABLE}."Donatos Pizza";;
}

dimension: Comfort_Inns {
  type: yesno
  sql: ${TABLE}."Comfort Inns";;
}
...
dimension: Big_5_Sporting {
  type: yesno
  sql: ${TABLE}."Big 5 Sporting";;
}

dimension: Blaze_Pizza {
  type: yesno
  sql: ${TABLE}."Blaze Pizza";;
}
...
dimension: Miller_S_Ale_House {
  type: yesno
  sql: ${TABLE}."Miller S Ale House";;
}

dimension: Thrifty_Car_Rental {
  type: yesno
  sql: ${TABLE}."Thrifty Car Rental";;
}

dimension: Antelope_Valley_Ford {
  type: yesno
  sql: ${TABLE}."Antelope Valley Ford";;
}

dimension: Hampton_Inn {
  type: yesno
  sql: ${TABLE}."Hampton Inn";;
}

dimension: Threadbeast {
  type: yesno
  sql: ${TABLE}."Threadbeast";;
}

dimension: Lenscrafters {
  type: yesno
  sql: ${TABLE}."Lenscrafters";;
}
...
dimension: Ysi_Addison_The {
  type: yesno
  sql: ${TABLE}."Ysi Addison The";;
}

dimension: Jack_In_The {
  type: yesno
  sql: ${TABLE}."Jack In The";;
}

dimension: Dollar_Gener {
  type: yesno
  sql: ${TABLE}."Dollar Gener";;
}

dimension: Dutch_Bros {
  type: yesno
  sql: ${TABLE}."Dutch Bros";;
}

dimension: Sixt_Rent_A_Car {
  type: yesno
  sql: ${TABLE}."Sixt Rent A Car";;
}

dimension: Wnb_new_Port_News {
  type: yesno
  sql: ${TABLE}."Wnb-new Port News";;
}

dimension: Frys_mktplace {
  type: yesno
  sql: ${TABLE}."Frys-mktplace";;
}

dimension: Thechildrensplace {
  type: yesno
  sql: ${TABLE}."Thechildrensplace";;
}
...
dimension: Gamlebanon {
  type: yesno
  sql: ${TABLE}."Gamlebanon";;
}

dimension: Quickbit.eu {
  type: yesno
  sql: ${TABLE}."Quickbit.eu";;
}
...
dimension: United_Airlines {
  type: yesno
  sql: ${TABLE}."United Airlines";;
}

dimension: Vmp_Performance {
  type: yesno
  sql: ${TABLE}."Vmp Performance";;
}

dimension: Spdpy_Americ {
  type: yesno
  sql: ${TABLE}."Spdpy Americ";;
}
...
dimension: Financial_Pacifi {
  type: yesno
  sql: ${TABLE}."Financial Pacifi";;
}

dimension: Edible_Arrangements {
  type: yesno
  sql: ${TABLE}."Edible Arrangements";;
}

dimension: Forman_Mills {
  type: yesno
  sql: ${TABLE}."Forman Mills";;
}

dimension: Coursehero {
  type: yesno
  sql: ${TABLE}."Coursehero";;
}
...
dimension: Playstatio {
  type: yesno
  sql: ${TABLE}."Playstatio";;
}

dimension: Alamo_Rent_a_car {
  type: yesno
  sql: ${TABLE}."Alamo Rent-a-car";;
}

dimension: Park_Cities_Dance {
  type: yesno
  sql: ${TABLE}."Park Cities Dance";;
}
...
dimension: Rack_Room_Shoes {
  type: yesno
  sql: ${TABLE}."Rack Room Shoes";;
}
...
dimension: Penn_Foster_Inc {
  type: yesno
  sql: ${TABLE}."Penn Foster Inc";;
}

dimension: Festival_Foods {
  type: yesno
  sql: ${TABLE}."Festival Foods";;
}
...
dimension: Ysi_Concord_Park {
  type: yesno
  sql: ${TABLE}."Ysi Concord Park";;
}

dimension: Holiday_Royale {
  type: yesno
  sql: ${TABLE}."Holiday Royale";;
}

dimension: Buffalo_Wild_Wing {
  type: yesno
  sql: ${TABLE}."Buffalo Wild Wing";;
}
...
dimension: Pennsylvania {
  type: yesno
  sql: ${TABLE}."Pennsylvania";;
}
...
dimension: Travelodge {
  type: yesno
  sql: ${TABLE}."Travelodge";;
}
...
dimension: Usa_Canteen_Vending {
  type: yesno
  sql: ${TABLE}."Usa Canteen Vending";;
}

dimension: O_co_overstock_com_O_co_overstock {
  type: yesno
  sql: ${TABLE}."O.co/overstock.com O.co/overstock";;
}

dimension: Instacoins {
  type: yesno
  sql: ${TABLE}."Instacoins";;
}

dimension: Ibi_Shoedazzle {
  type: yesno
  sql: ${TABLE}."Ibi Shoedazzle";;
}

dimension: Ysi_Station {
  type: yesno
  sql: ${TABLE}."Ysi Station";;
}

dimension: Hotel_Reservation {
  type: yesno
  sql: ${TABLE}."Hotel Reservation";;
}

dimension: Ysi_Pheasant_Run_Apart {
  type: yesno
  sql: ${TABLE}."Ysi Pheasant Run Apart";;
}

dimension: Advanceautoparts {
  type: yesno
  sql: ${TABLE}."Advanceautoparts";;
}

dimension: Cash_Aisle {
  type: yesno
  sql: ${TABLE}."Cash Aisle";;
}

dimension: Fanduel_Betfair_Pl {
  type: yesno
  sql: ${TABLE}."Fanduel Betfair Pl";;
}

dimension: Mcvay_Motors {
  type: yesno
  sql: ${TABLE}."Mcvay Motors";;
}

dimension: Sugarhouse {
  type: yesno
  sql: ${TABLE}."Sugarhouse";;
}

dimension: Comfort_Suites {
  type: yesno
  sql: ${TABLE}."Comfort Suites";;
}

dimension: Short_Stop {
  type: yesno
  sql: ${TABLE}."Short Stop";;
}

dimension: James_Avery {
  type: yesno
  sql: ${TABLE}."James Avery";;
}
...
dimension: Ipsy_Glam_Bag {
  type: yesno
  sql: ${TABLE}."Ipsy Glam Bag";;
}
...
dimension: Ktlpt_wayfair {
  type: yesno
  sql: ${TABLE}."Ktlpt-wayfair";;
}

dimension: Ubr_Pending.ube {
  type: yesno
  sql: ${TABLE}."Ubr Pending.ube";;
}

dimension: Mcalisters {
  type: yesno
  sql: ${TABLE}."Mcalister''s";;
}

dimension: Ysi_Main_Street_Renewal {
  type: yesno
  sql: ${TABLE}."Ysi Main Street Renewal";;
}

dimension: Holmes_Motors_Inc {
  type: yesno
  sql: ${TABLE}."Holmes Motors Inc";;
}
...
dimension: Redners_Mkts {
  type: yesno
  sql: ${TABLE}."Redners Mkts";;
}

dimension: Wesley_Chapel {
  type: yesno
  sql: ${TABLE}."Wesley Chapel";;
}

dimension: Save_Mart_Supermarkets {
  type: yesno
  sql: ${TABLE}."Save Mart Supermarkets";;
}
...
dimension: Fuzzys_Taco_Shop {
  type: yesno
  sql: ${TABLE}."Fuzzys Taco Shop";;
}

dimension: Evi_Seminole_Har {
  type: yesno
  sql: ${TABLE}."Evi Seminole Har";;
}

dimension: Palot_Center {
  type: yesno
  sql: ${TABLE}."Palot Center";;
}

dimension: Turo_Inc._Trip {
  type: yesno
  sql: ${TABLE}."Turo Inc. Trip";;
}

dimension: Badcock_And_More {
  type: yesno
  sql: ${TABLE}."Badcock And More";;
}
...
dimension: Twin_Peaks {
  type: yesno
  sql: ${TABLE}."Twin Peaks";;
}
...
dimension: Ventra_Mobile {
  type: yesno
  sql: ${TABLE}."Ventra Mobile";;
}

dimension: Sunglass_Hut {
  type: yesno
  sql: ${TABLE}."Sunglass Hut";;
}

dimension: Alliance_United {
  type: yesno
  sql: ${TABLE}."Alliance United";;
}

dimension: Main_Store {
  type: yesno
  sql: ${TABLE}."Main Store";;
}

dimension: Americas_Best {
  type: yesno
  sql: ${TABLE}."America''s Best" OR ${TABLE}."Americas Best";;
}
...
dimension: Katrina_Hogan {
  type: yesno
  sql: ${TABLE}."Katrina Hogan";;
}

dimension: Gucci_E_commerce {
  type: yesno
  sql: ${TABLE}."Gucci E-commerce";;
}

dimension: My_Car_Store {
  type: yesno
  sql: ${TABLE}."My Car Store";;
}

dimension: Loews_Hotels {
  type: yesno
  sql: ${TABLE}."Loews Hotels";;
}

dimension: Famousfootwear {
  type: yesno
  sql: ${TABLE}."Famousfootwear";;
}
...
dimension: Superior_Super_Whse {
  type: yesno
  sql: ${TABLE}."Superior Super Whse";;
}

dimension: Bite_Squad {
  type: yesno
  sql: ${TABLE}."Bite Squad";;
}
...
dimension: Dash_Of_Cash {
  type: yesno
  sql: ${TABLE}."Dash Of Cash";;
}

dimension: Quality_Inns {
  type: yesno
  sql: ${TABLE}."Quality Inns";;
}
...
dimension: Books_A_Million {
  type: yesno
  sql: ${TABLE}."Books A Million";;
}

dimension: Greyhound_Lines_Cnp {
  type: yesno
  sql: ${TABLE}."Greyhound Lines Cnp";;
}
...
dimension: Caseys_Gen {
  type: yesno
  sql: ${TABLE}."Caseys Gen";;
}
...
dimension: Ingles_Markets {
  type: yesno
  sql: ${TABLE}."Ingles Markets";;
}

dimension: Bahama_Breeze {
  type: yesno
  sql: ${TABLE}."Bahama Breeze";;
}

dimension: Penn_Station {
  type: yesno
  sql: ${TABLE}."Penn Station";;
}
...
dimension: Family_Express {
  type: yesno
  sql: ${TABLE}."Family Express";;
}

dimension: Bass_Pro_Store {
  type: yesno
  sql: ${TABLE}."Bass Pro Store";;
}

dimension: Church_S_Chicken {
  type: yesno
  sql: ${TABLE}."Church S Chicken";;
}

dimension: Chrysler_Capital {
  type: yesno
  sql: ${TABLE}."Chrysler Capital";;
}
...
dimension: Carters_Inc {
  type: yesno
  sql: ${TABLE}."Carters Inc.";;
}
...
dimension: Dollar_Rent_A_Car {
  type: yesno
  sql: ${TABLE}."Dollar Rent A Car";;
}

dimension: Westland_Auto_Inc {
  type: yesno
  sql: ${TABLE}."Westland Auto Inc";;
}
...
dimension: Western_Dental {
  type: yesno
  sql: ${TABLE}."Western Dental";;
}

dimension: Urban_Outfitters {
  type: yesno
  sql: ${TABLE}."Urban Outfitters";;
}

dimension: Hautlk_Rack {
  type: yesno
  sql: ${TABLE}."Hautlk Rack";;
}

dimension: The_Roku_Channel {
  type: yesno
  sql: ${TABLE}."The Roku Channel";;
}
...
dimension: Usa_Snack_Soda_Ven {
  type: yesno
  sql: ${TABLE}."Usa Snack Soda Ven";;
}

dimension: Wells_Fargo_C_A {
  type: yesno
  sql: ${TABLE}."Wells Fargo C A";;
}

dimension: 16_Intl_Diamond_Cente {
type: yesno
sql: ${TABLE}."#16 Intl Diamond Cente";;
}
...
dimension: Han_Dynasty {
  type: yesno
  sql: ${TABLE}."Han Dynasty";;
}
...
dimension: Mandalay_Villas {
  type: yesno
  sql: ${TABLE}."Mandalay Villas";;
}

dimension: Southwest_Airlines {
  type: yesno
  sql: ${TABLE}."Southwest Airlines";;
}

dimension: Microsoft_Ultimate_Msbill.info_Wa {
  type: yesno
  sql: ${TABLE}."Microsoft Ultimate Msbill.info Wa";;
}
...
dimension: Summit_Real {
  type: yesno
  sql: ${TABLE}."Summit Real";;
}

dimension: Tommy_Hilfiger {
  type: yesno
  sql: ${TABLE}."Tommy Hilfiger";;
}

dimension: C_Town_Supermarkets {
  type: yesno
  sql: ${TABLE}."C-Town Supermarkets";;
}

dimension: Country_Fair {
  type: yesno
  sql: ${TABLE}."Country Fair";;
}

dimension: Buddys {
  type: yesno
  sql: ${TABLE}."Buddy''s" OR ${TABLE}."Buddys";;
}

dimension: Kingdom_Chevrolet_Inc {
  type: yesno
  sql: ${TABLE}."Kingdom Chevrolet Inc";;
}

dimension: Walgreens_Store {
  type: yesno
  sql: ${TABLE}."Walgreens Store";;
}

dimension: Spotme_Tip {
  type: yesno
  sql: ${TABLE}."Spotme Tip";;
}
...
dimension: Aarons_Salo_C {
  type: yesno
  sql: ${TABLE}."Aarons Salo C";;
}
...
dimension: Avail_Blue_Db {
  type: yesno
  sql: ${TABLE}."Avail Blue Db";;
}
...
dimension: Shoppers_Food_Pharm {
  type: yesno
  sql: ${TABLE}."Shoppers Food Pharm";;
}
...
dimension: Aspire_Mastercard {
  type: yesno
  sql: ${TABLE}."Aspire Mastercard";;
}

dimension: Smashburger {
  type: yesno
  sql: ${TABLE}."Smashburger";;
}

dimension: Saks_Fifth_Ave {
  type: yesno
  sql: ${TABLE}."Saks Fifth Ave";;
}

dimension: Roses_Store {
  type: yesno
  sql: ${TABLE}."Roses Store";;
}

dimension: Cmsvend_Cv {
  type: yesno
  sql: ${TABLE}."Cmsvend Cv";;
}
...
dimension: Microsoft_Xb {
  type: yesno
  sql: ${TABLE}."Microsoft Xb";;
}

dimension: Eats_Help.uber_comca {
  type: yesno
  sql: ${TABLE}."Eats Help.uber.comca";;
}
...
dimension: Walton_Big_M {
  type: yesno
  sql: ${TABLE}."Walton Big M";;
}

dimension: Ysi_Invitation {
  type: yesno
  sql: ${TABLE}."Ysi Invitation";;
}
...
dimension: Enclave_At {
  type: yesno
  sql: ${TABLE}."Enclave At";;
}

dimension: Lyft_Pending {
  type: yesno
  sql: ${TABLE}."Lyft Pending";;
}
...
dimension: Economy_Inn {
  type: yesno
  sql: ${TABLE}."Economy Inn";;
}
...
dimension: Square_Enix {
  type: yesno
  sql: ${TABLE}."Square Enix";;
}

dimension: Kay_Jewelers {
  type: yesno
  sql: ${TABLE}."Kay Jewelers";;
}
...
dimension: A_Eagle_Outftr {
  type: yesno
  sql: ${TABLE}."A Eagle Outftr";;
}

dimension: Ic_Los_Angeles_Downtow {
  type: yesno
  sql: ${TABLE}."Ic Los Angeles Downtow";;
}

dimension: Frys_Market_Pl {
  type: yesno
  sql: ${TABLE}."Frys Market Pl";;
}

dimension: Imperfect_Foods {
  type: yesno
  sql: ${TABLE}."Imperfect Foods";;
}

dimension: Evi_Aria_Resor {
  type: yesno
  sql: ${TABLE}."Evi Aria Resor";;
}

dimension: Anytime_Fitness {
  type: yesno
  sql: ${TABLE}."Anytime Fitness";;
}
...
dimension: Alabama_Abc {
  type: yesno
  sql: ${TABLE}."Alabama Abc";;
}
...
dimension: Little_Caesa {
  type: yesno
  sql: ${TABLE}."Little Caesa";;
}
...
dimension: World_Acceptance_World {
  type: yesno
  sql: ${TABLE}."World Acceptance World";;
}
...
dimension: Bath_and_Body_Wo {
  type: yesno
  sql: ${TABLE}."Bath & Body Wo";;
}

dimension: Taco_Johns {
  type: yesno
  sql: ${TABLE}."Taco John''s";;
}

dimension: Jasons_Deli {
  type: yesno
  sql: ${TABLE}."Jason''s Deli";;
}

dimension: Cicis_Pizza {
  type: yesno
  sql: ${TABLE}."Cicis Pizza";;
}

dimension: Niantic_Inc {
  type: yesno
  sql: ${TABLE}."Niantic Inc";;
}

dimension: Sarku_Japan {
  type: yesno
  sql: ${TABLE}."Sarku Japan";;
}

dimension: Burberry_LTD {
  type: yesno
  sql: ${TABLE}."Burberry LTD";;
}

dimension: Deans_Bridge {
  type: yesno
  sql: ${TABLE}."Deans Bridge";;
}

dimension: Vantaggio_Suites_Vssd {
  type: yesno
  sql: ${TABLE}."Vantaggio Suites Vssd";;
}
...
dimension: Trade_Winds {
  type: yesno
  sql: ${TABLE}."Trade Winds";;
}

dimension: Charlotte_Russe {
  type: yesno
  sql: ${TABLE}."Charlotte Russe";;
}

dimension: Star_Market {
  type: yesno
  sql: ${TABLE}."Star Market";;
}

dimension: On_The_Border {
  type: yesno
  sql: ${TABLE}."On The Border";;
}

dimension: Sw_clintwood {
  type: yesno
  sql: ${TABLE}."Sw-clintwood";;
}

dimension: Independence_P {
  type: yesno
  sql: ${TABLE}."Independence P";;
}
...
dimension: Abc_Crunch_Fitness {
  type: yesno
  sql: ${TABLE}."Abc Crunch Fitness";;
}

dimension: Money_Corner {
  type: yesno
  sql: ${TABLE}."Money Corner";;
}
...
dimension: Pay_Portofino_Valenc {
  type: yesno
  sql: ${TABLE}."Pay Portofino Valenc";;
}
...
dimension: Blizzard_Entertain {
  type: yesno
  sql: ${TABLE}."Blizzard Entertain";;
}

dimension: Cosmopolitan_Fron {
  type: yesno
  sql: ${TABLE}."Cosmopolitan Fron";;
}

dimension: Bealls_Out {
  type: yesno
  sql: ${TABLE}."Bealls Out";;
}

dimension: Pollo_Tropical {
  type: yesno
  sql: ${TABLE}."Pollo Tropical";;
}

dimension: Caribou_Coffee {
  type: yesno
  sql: ${TABLE}."Caribou Coffee";;
}
...
dimension: Betrivers {
  type: yesno
  sql: ${TABLE}."Betrivers" OR ${TABLE}."Betrivers.";;
}

dimension: Greyhound_Lines {
  type: yesno
  sql: ${TABLE}."Greyhound Lines";;
}

dimension: Visionworks {
  type: yesno
  sql: ${TABLE}."Visionworks";;
}

dimension: K_Street_Dental_and_Ortho {
  type: yesno
  sql: ${TABLE}."K Street Dental & Ortho";;
}

dimension: Mammoth_Springs {
  type: yesno
  sql: ${TABLE}."Mammoth Springs";;
}

dimension: Mta_Mnr_Etix_Ticket {
  type: yesno
  sql: ${TABLE}."Mta Mnr Etix Ticket";;
}

dimension: Advanced_Auto {
  type: yesno
  sql: ${TABLE}."Advanced Auto";;
}

dimension: Everglades {
  type: yesno
  sql: ${TABLE}."Everglades";;
}

dimension: Parx_Casino {
  type: yesno
  sql: ${TABLE}."Parx Casino";;
}

dimension: Bob_Evans_Rest {
  type: yesno
  sql: ${TABLE}."Bob Evans Rest";;
}

dimension: Amazon_Marketplace {
  type: yesno
  sql: ${TABLE}."Amazon Marketplace";;
}

dimension: Ruby_Tuesday {
  type: yesno
  sql: ${TABLE}."Ruby Tuesday";;
}
...
dimension: Ubr_Pending.ub {
  type: yesno
  sql: ${TABLE}."Ubr Pending.ub";;
}
...
dimension: United_Oil {
  type: yesno
  sql: ${TABLE}."United Oil";;
}

dimension: Best_Furniture {
  type: yesno
  sql: ${TABLE}."Best Furniture";;
}
...
dimension: 1800flowers {
  type: yesno
  sql: ${TABLE}."1-800-flowers";;
}

dimension: Staybridge_Suites {
  type: yesno
  sql: ${TABLE}."Staybridge Suites";;
}

dimension: Skyline_Chili {
  type: yesno
  sql: ${TABLE}."Skyline Chili";;
}

dimension: Advance_Auto {
  type: yesno
  sql: ${TABLE}."Advance Auto";;
}

dimension: The_Missions_At {
  type: yesno
  sql: ${TABLE}."The Missions At";;
}

dimension: Desert_Financia {
  type: yesno
  sql: ${TABLE}."Desert Financia";;
}

dimension: Macau_Casino_Lak {
  type: yesno
  sql: ${TABLE}."Macau Casino Lak";;
}

dimension: Usa_Canteen {
  type: yesno
  sql: ${TABLE}."Usa Canteen";;
}

dimension: Dom_Windrift {
  type: yesno
  sql: ${TABLE}."Dom Windrift";;
}

dimension: Uptown_Suites {
  type: yesno
  sql: ${TABLE}."Uptown Suites";;
}

dimension: Boxycharm_Monthly_Box {
  type: yesno
  sql: ${TABLE}."Boxycharm Monthly Box";;
}

dimension: Or_Liquor_Store {
  type: yesno
  sql: ${TABLE}."Or Liquor Store";;
}
...
dimension: North_Haven {
  type: yesno
  sql: ${TABLE}."North Haven";;
}
...
dimension: Pfs_Mobile {
  type: yesno
  sql: ${TABLE}."Pfs Mobile";;
}
...
dimension: Smokey_Bones {
  type: yesno
  sql: ${TABLE}."Smokey Bones";;
}
...
dimension: The_Granite_Group_Port {
  type: yesno
  sql: ${TABLE}."The Granite Group Port";;
}

dimension: Restaurant_Depot {
  type: yesno
  sql: ${TABLE}."Restaurant Depot";;
}

dimension: Hardrock_Hotel_Res {
  type: yesno
  sql: ${TABLE}."Hardrock Hotel Res";;
}

dimension: Ford_Motor_Cr {
  type: yesno
  sql: ${TABLE}."Ford Motor Cr";;
}
...
dimension: Ysi_Rci_Tuscana_L {
  type: yesno
  sql: ${TABLE}."Ysi Rci Tuscana L";;
}
...
dimension: Maya_Linda_Ii {
  type: yesno
  sql: ${TABLE}."Maya Linda Ii";;
}

dimension: Evi_Casino_Ari {
  type: yesno
  sql: ${TABLE}."Evi Casino Ari";;
}

dimension: Family_Credit_Se {
  type: yesno
  sql: ${TABLE}."Family Credit Se";;
}

dimension: Ysi_Alterra_At_Ov {
  type: yesno
  sql: ${TABLE}."Ysi Alterra At Ov";;
}

dimension: Aarons_Online_Pa {
  type: yesno
  sql: ${TABLE}."Aaron''s Online Pa";;
}

dimension: Foxbet_Sta {
  type: yesno
  sql: ${TABLE}."Foxbet Sta";;
}

dimension: Nfcu_Branches {
  type: yesno
  sql: ${TABLE}."Nfcu Branches";;
}

dimension: Evi_Tulalip_Reso {
  type: yesno
  sql: ${TABLE}."Evi Tulalip Reso";;
}

dimension: BJs_Wholesale_Club_Fuel {
  type: yesno
  sql: ${TABLE}."BJ''s Wholesale Club Fuel";;
}

dimension: Regional_Acceptan {
  type: yesno
  sql: ${TABLE}."Regional Acceptan";;
}

dimension: Ysi_Gables {
  type: yesno
  sql: ${TABLE}."Ysi Gables";;
}

dimension: Resorts_wdtc {
  type: yesno
  sql: ${TABLE}."Resorts-wdtc";;
}

dimension: Strack_and_Van_Til {
  type: yesno
  sql: ${TABLE}."Strack & Van Til";;
}

dimension: The_Olive_Gard {
  type: yesno
  sql: ${TABLE}."The Olive Gard";;
}

dimension: Ntta_Autocharge {
  type: yesno
  sql: ${TABLE}."Ntta Autocharge";;
}
...
dimension: Cash_Saver {
  type: yesno
  sql: ${TABLE}."Cash Saver";;
}

dimension: Best_Buy_Mht {
  type: yesno
  sql: ${TABLE}."Best Buy Mht";;
}

dimension: Churchsatnormandy {
  type: yesno
  sql: ${TABLE}."Churchsatnormandy";;
}
...
dimension: Wise_Credit {
  type: yesno
  sql: ${TABLE}."Wise Credit";;
}
...
dimension: Comfort_Inn {
  type: yesno
  sql: ${TABLE}."Comfort Inn";;
}
...
dimension: Napa_Store {
  type: yesno
  sql: ${TABLE}."Napa Store";;
}

dimension: Buddys_Home_Furnishing {
  type: yesno
  sql: ${TABLE}."Buddy''s Home Furnishing";;
}

dimension: Dicks_Clothing_and_sportin {
  type: yesno
  sql: ${TABLE}."Dick''s Clothing&sportin";;
}

dimension: Speedy_Stop {
  type: yesno
  sql: ${TABLE}."Speedy Stop";;
}

dimension: Med._Village {
  type: yesno
  sql: ${TABLE}."Med. Village";;
}
...
dimension: Pet_Supermarket {
  type: yesno
  sql: ${TABLE}."Pet Supermarket";;
}

dimension: Imos_Pizza {
  type: yesno
  sql: ${TABLE}."Imos Pizza";;
}

dimension: Intown_Suites {
  type: yesno
  sql: ${TABLE}."Intown Suites";;
}

dimension: La_Quinta_Inn {
  type: yesno
  sql: ${TABLE}."La Quinta Inn";;
}

dimension: Ysi_Walton_On_The_Chat {
  type: yesno
  sql: ${TABLE}."Ysi Walton On The Chat";;
}

dimension: Performance_Race_Eng_Ll {
  type: yesno
  sql: ${TABLE}."Performance Race Eng Ll";;
}
...
dimension: Windsor_Fashions {
  type: yesno
  sql: ${TABLE}."Windsor Fashions";;
}

dimension: Huddle_House {
  type: yesno
  sql: ${TABLE}."Huddle House";;
}

dimension: Aafes_hump_Main_Store {
  type: yesno
  sql: ${TABLE}."Aafes-hump Main Store";;
}

dimension: Saloncentric {
  type: yesno
  sql: ${TABLE}."Saloncentric";;
}

dimension: Fingerhut_Paym {
  type: yesno
  sql: ${TABLE}."Fingerhut Paym";;
}
...
dimension: Fastrak_Csc {
  type: yesno
  sql: ${TABLE}."Fastrak Csc";;
}

dimension: Walls_Furniture_and_Matt {
  type: yesno
  sql: ${TABLE}."Walls Furniture & Matt";;
}
...
dimension: In_Silverreef_Transpo {
  type: yesno
  sql: ${TABLE}."In Silverreef Transpo";;
}

dimension: An_Nissan_Temp {
  type: yesno
  sql: ${TABLE}."An Nissan Temp";;
}

dimension: Dodge_Store {
  type: yesno
  sql: ${TABLE}."Dodge Store";;
}
...
dimension: Spirit_Halloweenc {
  type: yesno
  sql: ${TABLE}."Spirit Halloweenc";;
}

dimension: 99_Cents_Only_St {
  type: yesno
  sql: ${TABLE}."99 Cents Only St";;
}

dimension: Disney_Plus {
  type: yesno
  sql: ${TABLE}."Disney Plus";;
}
...
dimension: Aci_Ally_Auto {
  type: yesno
  sql: ${TABLE}."Aci Ally Auto";;
}

dimension: Suitsupplypos_boston {
  type: yesno
  sql: ${TABLE}."Suitsupplypos_boston";;
}

dimension: Draft_Kings {
  type: yesno
  sql: ${TABLE}."Draft Kings";;
}

dimension: Lane_Bryant {
  type: yesno
  sql: ${TABLE}."Lane Bryant";;
}

dimension: Coast_To_Coast_Motors {
  type: yesno
  sql: ${TABLE}."Coast To Coast Motors";;
}

dimension: Ysi_Charleston {
  type: yesno
  sql: ${TABLE}."Ysi Charleston";;
}

dimension: Abc_Eos_Fitness {
  type: yesno
  sql: ${TABLE}."Abc Eos Fitness";;
}

dimension: Minit_Mart {
  type: yesno
  sql: ${TABLE}."Minit Mart";;
}

dimension: Fresco_Y_Mas {
  type: yesno
  sql: ${TABLE}."Fresco Y Mas";;
}
...
dimension: Lc_Variety {
  type: yesno
  sql: ${TABLE}."Lc Variety";;
}

dimension: Ace_Hardware {
  type: yesno
  sql: ${TABLE}."Ace Hardware";;
}

dimension: Mta_Metrocard {
  type: yesno
  sql: ${TABLE}."Mta Metrocard";;
}
...
dimension: Ysi_Palmer_Park {
  type: yesno
  sql: ${TABLE}."Ysi Palmer Park";;
}

dimension: Charleys_Philly_Steaks {
  type: yesno
  sql: ${TABLE}."Charleys Philly Steaks";;
}

dimension: Vtg_Tranquility {
  type: yesno
  sql: ${TABLE}."Vtg Tranquility";;
}

dimension: Noodles_and_Company {
  type: yesno
  sql: ${TABLE}."Noodles & Company";;
}

dimension: Tarzana_Dental_Care_cl {
  type: yesno
  sql: ${TABLE}."Tarzana Dental Care -cl";;
}

dimension: Tarzana_Dental_Ca {
  type: yesno
  sql: ${TABLE}."Tarzana Dental Ca";;
}

dimension: Community_Ch {
  type: yesno
  sql: ${TABLE}."Community Ch";;
}
...
dimension: Community_Choice_F {
  type: yesno
  sql: ${TABLE}."Community Choice F";;
}

dimension: Performance_Race {
  type: yesno
  sql: ${TABLE}."Performance Race";;
}

dimension: Great_Wolf {
  type: yesno
  sql: ${TABLE}."Great Wolf";;
}

dimension: The_Cash_Store {
  type: yesno
  sql: ${TABLE}."The Cash Store";;
}

dimension: Market_District {
  type: yesno
  sql: ${TABLE}."Market District";;
}

dimension: Round_Table_Pizza {
  type: yesno
  sql: ${TABLE}."Round Table Pizza";;
}

dimension: Auntie_Annes {
  type: yesno
  sql: ${TABLE}."Auntie Anne''s";;
}
...
dimension: Sixt_collegep_pos {
  type: yesno
  sql: ${TABLE}."Sixt_collegep_pos";;
}

dimension: Stinker_Stores {
  type: yesno
  sql: ${TABLE}."Stinker Stores";;
}
...
dimension: Bella_Vida_At_Co {
  type: yesno
  sql: ${TABLE}."Bella Vida At Co";;
}

dimension: Tuttle_Road {
  type: yesno
  sql: ${TABLE}."Tuttle Road";;
}

dimension: William_Hill {
  type: yesno
  sql: ${TABLE}."William Hill";;
}

dimension: Ysi_Inland_Residential {
  type: yesno
  sql: ${TABLE}."Ysi Inland Residential";;
}

dimension: West_Point_Inn {
  type: yesno
  sql: ${TABLE}."West Point Inn";;
}
...
dimension: Usa_Real_Estate {
  type: yesno
  sql: ${TABLE}."Usa Real Estate";;
}

dimension: Bath_And_Body_W {
  type: yesno
  sql: ${TABLE}."Bath And Body W";;
}

dimension: Camden_Royal {
  type: yesno
  sql: ${TABLE}."Camden Royal";;
}

dimension: Reliable_Auto_Finance {
  type: yesno
  sql: ${TABLE}."Reliable Auto Finance";;
}

dimension: Lynnewood_Gardens {
  type: yesno
  sql: ${TABLE}."Lynnewood Gardens";;
}

dimension: Cost_Plus_World_Market {
  type: yesno
  sql: ${TABLE}."Cost Plus World Market";;
}
...
dimension: Victoriassecret.co {
  type: yesno
  sql: ${TABLE}."Victoriassecret.co";;
}
...
dimension: Ysi_Ivy_Commons {
  type: yesno
  sql: ${TABLE}."Ysi Ivy Commons";;
}

dimension: Teco_Peoples_Gas {
  type: yesno
  sql: ${TABLE}."Teco Peoples Gas";;
}
...
dimension: Dicks_Clothin {
  type: yesno
  sql: ${TABLE}."Dick''s Clothin";;
}
...
dimension: Boston_Market {
  type: yesno
  sql: ${TABLE}."Boston Market";;
}
...
dimension: H.a_Tall_Oaks {
  type: yesno
  sql: ${TABLE}."H.a. Tall Oaks";;
}
...
dimension: Ysi_Amg_Cityview_Apts {
  type: yesno
  sql: ${TABLE}."Ysi Amg Cityview Apts";;
}

dimension: Holiday_Stat {
  type: yesno
  sql: ${TABLE}."Holiday Stat";;
}

dimension: Newwavsprklight {
  type: yesno
  sql: ${TABLE}."Newwavsprklight";;
}

dimension: Louis_Vuitton {
  type: yesno
  sql: ${TABLE}."Louis Vuitton";;
}

dimension: Woodmans_Food_M {
  type: yesno
  sql: ${TABLE}."Woodmans Food M";;
}

dimension: Panda_Expres {
  type: yesno
  sql: ${TABLE}."Panda Expres";;
}
...
dimension: Fresh_Thyme {
  type: yesno
  sql: ${TABLE}."Fresh Thyme";;
}

dimension: Sugarhouse_Play {
  type: yesno
  sql: ${TABLE}."Sugarhouse Play";;
}

dimension: Sonesta_Hotels {
  type: yesno
  sql: ${TABLE}."Sonesta Hotels";;
}

dimension: Embassy_Suites {
  type: yesno
  sql: ${TABLE}."Embassy Suites";;
}

dimension: Pay_Fairfield_Townhouse {
  type: yesno
  sql: ${TABLE}."Pay Fairfield Townhouse";;
}

dimension: Giant_Fuel {
  type: yesno
  sql: ${TABLE}."Giant Fuel";;
}
...
dimension: Matco_Tools {
  type: yesno
  sql: ${TABLE}."Matco Tools";;
}
...
dimension: Inspire_Preschool_East {
  type: yesno
  sql: ${TABLE}."Inspire Preschool East";;
}

dimension: Smoker_Friendly {
  type: yesno
  sql: ${TABLE}."Smoker Friendly";;
}
...
dimension: Af_Providence_Real_Es {
  type: yesno
  sql: ${TABLE}."Af Providence Real Es";;
}

dimension: Harris_Cacusa {
  type: yesno
  sql: ${TABLE}."Harris- Cacusa";;
}
...
dimension: Taco_Bueno {
  type: yesno
  sql: ${TABLE}."Taco Bueno";;
}

dimension: Oral_Surgery_Group_Evan {
  type: yesno
  sql: ${TABLE}."Oral Surgery Group Evan";;
}
...
dimension: Caseys_Pizza {
  type: yesno
  sql: ${TABLE}."Caseys Pizza";;
}

dimension: Choice_Cars {
  type: yesno
  sql: ${TABLE}."Choice Cars";;
}
...
dimension: Pca_Lady_Luck_Vicksburg {
  type: yesno
  sql: ${TABLE}."Pca Lady Luck Vicksburg";;
}

dimension: State_Street {
  type: yesno
  sql: ${TABLE}."State Street";;
}

dimension: Banana_Visa {
  type: yesno
  sql: ${TABLE}."Banana Visa";;
}
...
dimension: Turner_Acceptance_ {
  type: yesno
  sql: ${TABLE}."Turner Acceptance --";;
}

dimension: Easy_Money {
  type: yesno
  sql: ${TABLE}."Easy Money";;
}
...
dimension: Blink_Moto {
  type: yesno
  sql: ${TABLE}."Blink Moto";;
}

dimension: Pay_G.co_walleth {
  type: yesno
  sql: ${TABLE}."Pay G.co/walleth#," OR ${TABLE}."Pay G.co/walleth#" OR ${TABLE}."G.co/walleth#ca";;
}

dimension: Nayax_Vending_Machine {
  type: yesno
  sql: ${TABLE}."Nayax Vending Machine";;
}

dimension: Jolie_Plastic_Surgery {
  type: yesno
  sql: ${TABLE}."Jolie Plastic Surgery";;
}

dimension: Extended_Stay_Hou {
  type: yesno
  sql: ${TABLE}."Extended Stay Hou";;
}

dimension: Il_Tollway_web {
  type: yesno
  sql: ${TABLE}."Il Tollway-web";;
}

dimension: Priceln_La_Quinta {
  type: yesno
  sql: ${TABLE}."Priceln La Quinta";;
}

dimension: Stefany_Lee {
  type: yesno
  sql: ${TABLE}."Stefany Lee";;
}

dimension: Smoke_Bucks {
  type: yesno
  sql: ${TABLE}."Smoke Bucks";;
}

dimension: Ticketmaster {
  type: yesno
  sql: ${TABLE}."Ticketmaster";;
}

dimension: Evi_Ameristar_vi {
  type: yesno
  sql: ${TABLE}."Evi Ameristar-vi";;
}
...
dimension: Emoney_Usa {
  type: yesno
  sql: ${TABLE}."Emoney Usa";;
}
...
dimension: Premiere_Manufacturing {
  type: yesno
  sql: ${TABLE}."Premiere Manufacturing";;
}

dimension: Mk_Cosmetic {
  type: yesno
  sql: ${TABLE}."Mk Cosmetic";;
}

dimension: Tjgunsales {
  type: yesno
  sql: ${TABLE}."Tjgunsales";;
}
...
dimension: Burkes_Out {
  type: yesno
  sql: ${TABLE}."Burkes Out";;
}

dimension: Drive_Casa_LLC {
  type: yesno
  sql: ${TABLE}."Drive Casa LLC";;
}

dimension: Rodeway_Inn {
  type: yesno
  sql: ${TABLE}."Rodeway Inn";;
}

dimension: Super_8_Motels {
  type: yesno
  sql: ${TABLE}."Super 8 Motels";;
}
...
dimension: Starbucks_Store {
  type: yesno
  sql: ${TABLE}."Starbucks Store";;
}
...
dimension: Central_Market {
  type: yesno
  sql: ${TABLE}."Central Market";;
}

dimension: Market_Place {
  type: yesno
  sql: ${TABLE}."Market Place";;
}

dimension: Wdw_Disney_Tickets {
  type: yesno
  sql: ${TABLE}."Wdw Disney Tickets";;
}

dimension: Furry_Babies_Fox_Valle {
  type: yesno
  sql: ${TABLE}."Furry Babies Fox Valle";;
}
...
dimension: KinderCare {
  type: yesno
  sql: ${TABLE}."KinderCare";;
}

dimension: Sylvia_Cha {
  type: yesno
  sql: ${TABLE}."Sylvia Cha";;
}

dimension: Rps_Preserve_At_Bal {
  type: yesno
  sql: ${TABLE}."Rps Preserve At Bal";;
}

dimension: Wayfair_Way {
  type: yesno
  sql: ${TABLE}."Wayfair Way";;
}

dimension: Disney_Resorts_wdtc {
  type: yesno
  sql: ${TABLE}."Disney Resorts-wdtc";;
}

dimension: Rotens_Furniture {
  type: yesno
  sql: ${TABLE}."Rotens Furniture";;
}
...
dimension: Turo_Inc._Trip_S {
  type: yesno
  sql: ${TABLE}."Turo Inc. Trip S";;
}

dimension: Loves_Cntry_St {
  type: yesno
  sql: ${TABLE}."Loves Cntry St";;
}
...
dimension: Golf_Creek {
  type: yesno
  sql: ${TABLE}."Golf Creek";;
}
...
dimension: Contacts_Subscription {
  type: yesno
  sql: ${TABLE}."Contacts Subscription";;
}
...
dimension: Mnrd_princeton {
  type: yesno
  sql: ${TABLE}."Mnrd-princeton";;
}
...
dimension: Amazon_Payments {
  type: yesno
  sql: ${TABLE}."Amazon Payments";;
}

dimension: Goldfingers_Bar {
  type: yesno
  sql: ${TABLE}."Goldfingers Bar";;
}

dimension: Cornwell_Tools {
  type: yesno
  sql: ${TABLE}."Cornwell Tools";;
}

dimension: Bobs_Discount_Onl {
  type: yesno
  sql: ${TABLE}."Bob''s Discount Onl";;
}

dimension: Mulligans_Pub {
  type: yesno
  sql: ${TABLE}."Mulligans Pub";;
}
...
dimension: Wayfield_Foods {
  type: yesno
  sql: ${TABLE}."Wayfield Foods";;
}
...
dimension: The_Fresh_Marke {
  type: yesno
  sql: ${TABLE}."The Fresh Marke";;
}

dimension: Cumberland_Rent_Co {
  type: yesno
  sql: ${TABLE}."Cumberland Rent Co";;
}

dimension: Beverages_and_Mor {
  type: yesno
  sql: ${TABLE}."Beverages & Mor";;
}

dimension: Gap_Outlet_Us {
  type: yesno
  sql: ${TABLE}."Gap Outlet Us";;
}

dimension: Ysi_Crest_At {
  type: yesno
  sql: ${TABLE}."Ysi Crest At";;
}
...
dimension: 5_Star_Furnitu {
  type: yesno
  sql: ${TABLE}."5 Star Furnitu";;
}

dimension: Stop_and_S_Raynham {
  type: yesno
  sql: ${TABLE}."Stop & S Raynham";;
}

dimension: Avenue_C_Canteen {
  type: yesno
  sql: ${TABLE}."Avenue C Canteen";;
}

dimension: Elevation_Church {
  type: yesno
  sql: ${TABLE}."Elevation Church";;
}
...
dimension: Zenni_Optical {
  type: yesno
  sql: ${TABLE}."Zenni Optical";;
}
...
dimension: Home_Choice {
  type: yesno
  sql: ${TABLE}."Home Choice";;
}
...
dimension: Exeter_Auto_Rec {
  type: yesno
  sql: ${TABLE}."Exeter Auto Rec";;
}

dimension: Meridien_Hotels {
  type: yesno
  sql: ${TABLE}."Meridien Hotels";;
}
...
dimension: Village_Pantry {
  type: yesno
  sql: ${TABLE}."Village Pantry";;
}

dimension: Dollar_Gen {
  type: yesno
  sql: ${TABLE}."Dollar Gen";;
}

dimension: Benjamin_H {
  type: yesno
  sql: ${TABLE}."Benjamin H.";;
}

dimension: Marathon_P {
  type: yesno
  sql: ${TABLE}."Marathon P";;
}

dimension: Green_Mountain {
  type: yesno
  sql: ${TABLE}."Green Mountain";;
}

dimension: Ysi_Schooner_Be {
  type: yesno
  sql: ${TABLE}."Ysi Schooner Be";;
}
...
dimension: Rooms_To_Go {
  type: yesno
  sql: ${TABLE}."Rooms To Go";;
}

dimension: Buckys_Store {
  type: yesno
  sql: ${TABLE}."Bucky''s Store";;
}

dimension: Shooters_Supply {
  type: yesno
  sql: ${TABLE}."Shooters Supply";;
}

dimension: Potbelly_Sandwich_Shop {
  type: yesno
  sql: ${TABLE}."Potbelly Sandwich Shop";;
}

dimension: Capital_Grille {
  type: yesno
  sql: ${TABLE}."Capital Grille";;
}

dimension: Playrix_Games {
  type: yesno
  sql: ${TABLE}."Playrix Games";;
}

dimension: Microsoft_Ultimate_1_Mo {
  type: yesno
  sql: ${TABLE}."Microsoft Ultimate 1 Mo";;
}

dimension: Edible_Arrangement {
  type: yesno
  sql: ${TABLE}."Edible Arrangement";;
}

dimension: Pacific_Ride_Tesla {
  type: yesno
  sql: ${TABLE}."Pacific Ride Tesla";;
}

dimension: Smart_And_Fina {
  type: yesno
  sql: ${TABLE}."Smart And Fina";;
}

dimension: Asu_Student_Accounts {
  type: yesno
  sql: ${TABLE}."Asu Student Accounts";;
}
...
dimension: Abf_Transportation_Svc {
  type: yesno
  sql: ${TABLE}."Abf Transportation Svc";;
}
...
dimension: Patient_Pay_Serv_Pos {
  type: yesno
  sql: ${TABLE}."Patient Pay Serv Pos";;
}

dimension: Flagship_Cre {
  type: yesno
  sql: ${TABLE}."Flagship Cre";;
}

dimension: Candlewood_Suites {
  type: yesno
  sql: ${TABLE}."Candlewood Suites";;
}

dimension: Chuckles_Stores {
  type: yesno
  sql: ${TABLE}."Chuckles Stores";;
}

dimension: Buybuybaby {
  type: yesno
  sql: ${TABLE}."Buybuybaby";;
}
...
dimension: Aarons_Cnp {
  type: yesno
  sql: ${TABLE}."Aarons Cnp";;
}

dimension: Churchs_Chicken {
  type: yesno
  sql: ${TABLE}."Church''s Chicken";;
}

dimension: Bloomingdales {
  type: yesno
  sql: ${TABLE}."Bloomingdales";;
}

dimension: Black_Diamond {
  type: yesno
  sql: ${TABLE}."Black Diamond";;
}
...
dimension: Pearl_Holding_Group {
  type: yesno
  sql: ${TABLE}."Pearl Holding Group";;
}
...
dimension: Ppl_Team_Beachbody {
  type: yesno
  sql: ${TABLE}."Ppl Team Beachbody";;
}

dimension: Evi_Pechanga {
  type: yesno
  sql: ${TABLE}."Evi Pechanga";;
}

dimension: Ft_Bliss_Commiss {
  type: yesno
  sql: ${TABLE}."Ft Bliss Commiss";;
}

dimension: Black_Diamond_Rv {
  type: yesno
  sql: ${TABLE}."Black Diamond Rv";;
}
...
dimension: Moes_Sw_Grill {
  type: yesno
  sql: ${TABLE}."Moe''s Sw Grill";;
}
...
dimension: Us_Auto_Credit_Purchas {
  type: yesno
  sql: ${TABLE}."Us Auto Credit Purchas";;
}

dimension: Press_House {
  type: yesno
  sql: ${TABLE}."Press House";;
}
...
dimension: Papa_Murphys {
  type: yesno
  sql: ${TABLE}."Papa Murphy''s";;
}

dimension: Spin_Scooter {
  type: yesno
  sql: ${TABLE}."Spin Scooter";;
}
...
dimension: Veterans_Canteen {
  type: yesno
  sql: ${TABLE}."Veterans Canteen";;
}

dimension: Prog_Advanced {
  type: yesno
  sql: ${TABLE}."Prog Advanced";;
}
...
dimension: Pay_G_co_helppay {
  type: yesno
  sql: ${TABLE}."Pay G.co/helppay#";;
}
...
dimension: Acceptancenow.c {
  type: yesno
  sql: ${TABLE}."Acceptancenow.c";;
}

dimension: Rps_Solstice_Rd {
  type: yesno
  sql: ${TABLE}."Rps Solstice Rd";;
}
...
dimension: Fanduel_Dep {
  type: yesno
  sql: ${TABLE}."Fanduel Dep";;
}

dimension: American_Coastal_C {
  type: yesno
  sql: ${TABLE}."American Coastal C";;
}

dimension: Lanebryant {
  type: yesno
  sql: ${TABLE}."Lanebryant";;
}

dimension: Igt_Kentucky_Lottery {
  type: yesno
  sql: ${TABLE}."Igt- Kentucky Lottery";;
}

dimension: Claim_Reversal {
  type: yesno
  sql: ${TABLE}."Claim Reversal";;
}

dimension: Wm_Supercent {
  type: yesno
  sql: ${TABLE}."Wm Supercent";;
}

dimension: Sweetwater_Sound {
  type: yesno
  sql: ${TABLE}."Sweetwater Sound";;
}

dimension: Extra_Space {
  type: yesno
  sql: ${TABLE}."Extra Space";;
}

dimension: Element_Vape {
  type: yesno
  sql: ${TABLE}."Element Vape";;
}

dimension: Blinds_To_Go {
  type: yesno
  sql: ${TABLE}."Blinds To Go";;
}

dimension: Carson_Main_Store {
  type: yesno
  sql: ${TABLE}."Carson Main Store";;
}

dimension: Kate_Spade {
  type: yesno
  sql: ${TABLE}."Kate Spade";;
}

dimension: Facebookpay {
  type: yesno
  sql: ${TABLE}."Facebookpay";;
}

dimension: Buffalo_Wild {
  type: yesno
  sql: ${TABLE}."Buffalo Wild";;
}

dimension: Psu_Tuitionfee {
  type: yesno
  sql: ${TABLE}."Psu Tuitionfee";;
}
...
dimension: Facts_Tuition_And_Fees {
  type: yesno
  sql: ${TABLE}."Facts Tuition And Fees";;
}

dimension: Quick_Mart {
  type: yesno
  sql: ${TABLE}."Quick Mart";;
}
...
dimension: Intown_Suites_Athens {
  type: yesno
  sql: ${TABLE}."Intown Suites Athens";;
}

dimension: Handy_Mart {
  type: yesno
  sql: ${TABLE}."Handy Mart";;
}

dimension: Sli_gn_Prepaid {
  type: yesno
  sql: ${TABLE}."Sli-gn Prepaid";;
}
...
dimension: Af_Horizon_Realty_and_P {
  type: yesno
  sql: ${TABLE}."Af Horizon Realty & P.";;
}
...
dimension: Burlington_S {
  type: yesno
  sql: ${TABLE}."Burlington S";;
}

dimension: Mellow_Mushroom {
  type: yesno
  sql: ${TABLE}."Mellow Mushroom";;
}

dimension: Ysi_Invitation_Hom {
  type: yesno
  sql: ${TABLE}."Ysi Invitation Hom";;
}

dimension: Medicredit_Inc {
  type: yesno
  sql: ${TABLE}."Medicredit Inc";;
}
...
dimension: Shore_Stop {
  type: yesno
  sql: ${TABLE}."Shore Stop";;
}
...
dimension: Canvas_Credit_Union {
  type: yesno
  sql: ${TABLE}."Canvas Credit Union";;
}

dimension: G_Flightclub {
  type: yesno
  sql: ${TABLE}."G Flightclub";;
}

dimension: Americas_First {
  type: yesno
  sql: ${TABLE}."America''s First";;
}
...
dimension: Card_Check_Card_Aero_Motel {
  type: yesno
  sql: ${TABLE}."Card Check Card Aero Motel";;
}

dimension: Meridien_Ho {
  type: yesno
  sql: ${TABLE}."Meridien Ho";;
}
...
dimension: Courtyard_By_Marri {
  type: yesno
  sql: ${TABLE}."Courtyard By Marri";;
}

dimension: Bnkofgeorge_hlywd {
  type: yesno
  sql: ${TABLE}."Bnkofgeorge-hlywd";;
}

dimension: Priceln_Residence_Inn {
  type: yesno
  sql: ${TABLE}."Priceln Residence Inn";;
}
...
dimension: Central_Flats {
  type: yesno
  sql: ${TABLE}."Central Flats";;
}

dimension: Candle_Science_Inc {
  type: yesno
  sql: ${TABLE}."Candle Science Inc.";;
}

dimension: Ford_Motor_Credit_Company {
  type: yesno
  sql: ${TABLE}."Ford Motor Credit Company";;
}
...
dimension: La_Quinta_Inn_and_Suites {
  type: yesno
  sql: ${TABLE}."La Quinta Inn & Suites";;
}

dimension: Evi_Soboba_Casin {
  type: yesno
  sql: ${TABLE}."Evi Soboba Casin";;
}
...
dimension: Academy_Spor {
  type: yesno
  sql: ${TABLE}."Academy Spor";;
}

dimension: Gallery_Furniture {
  type: yesno
  sql: ${TABLE}."Gallery Furniture";;
}

dimension: Global_Inc {
  type: yesno
  sql: ${TABLE}."Global Inc";;
}

dimension: Liberty_Univ {
  type: yesno
  sql: ${TABLE}."Liberty Univ";;
}

dimension: Pandora_Ecommerce {
  type: yesno
  sql: ${TABLE}."Pandora Ecommerce";;
}

dimension: Ae_Outf_Online {
  type: yesno
  sql: ${TABLE}."Ae Outf Online";;
}
...
dimension: Dicks_Clothing_and_sporti {
  type: yesno
  sql: ${TABLE}."Dick''s Clothing&sporti";;
}
...
dimension: Ysi_Oak_Park_Operati {
  type: yesno
  sql: ${TABLE}."Ysi Oak Park Operati";;
}
...
dimension: Marathon_Pet {
  type: yesno
  sql: ${TABLE}."Marathon Pet";;
}

dimension: Kids_Foot_Lock {
  type: yesno
  sql: ${TABLE}."Kids Foot Lock";;
}

dimension: Levis_Outlet {
  type: yesno
  sql: ${TABLE}."Levis Outlet";;
}

dimension: Af_Gibraltar_Llc {
  type: yesno
  sql: ${TABLE}."Af Gibraltar Llc.";;
}

dimension: First_Midwest {
  type: yesno
  sql: ${TABLE}."First Midwest";;
}

dimension: Checkfreepay_Auto {
  type: yesno
  sql: ${TABLE}."Checkfreepay Auto";;
}

dimension: Brookshire_Brothers {
  type: yesno
  sql: ${TABLE}."Brookshire Brothers";;
}

dimension: Raising_Cane {
  type: yesno
  sql: ${TABLE}."Raising Cane";;
}

dimension: Dior_Chicago {
  type: yesno
  sql: ${TABLE}."Dior Chicago";;
}

dimension: Verizonwrlss_Rtccr_Vw {
  type: yesno
  sql: ${TABLE}."Verizonwrlss Rtccr Vw";;
}

dimension: Sts_mavis_Tire {
  type: yesno
  sql: ${TABLE}."Sts-mavis Tire";;
}

dimension: Delta_Internet {
  type: yesno
  sql: ${TABLE}."Delta Internet";;
}

dimension: Missguided {
  type: yesno
  sql: ${TABLE}."Missguided";;
}
...
dimension: Sli_tvg_Prepaid {
  type: yesno
  sql: ${TABLE}."Sli-tvg Prepaid";;
}

dimension: Ysi_Village_Highlands {
  type: yesno
  sql: ${TABLE}."Ysi Village Highlands";;
}

dimension: Ipsy_Glam_Bag_Plus {
  type: yesno
  sql: ${TABLE}."Ipsy Glam Bag Plus";;
}

dimension: Dicks_Clothing_and_sporting {
  type: yesno
  sql: ${TABLE}."Dick''s Clothing&sporting";;
}
...
dimension: Owings_Auto {
  type: yesno
  sql: ${TABLE}."Owings Auto";;
}

dimension: Zyia_Active_LLC {
  type: yesno
  sql: ${TABLE}."Zyia Active LLC";;
}
...
dimension: Wal_Bratislava {
  type: yesno
  sql: ${TABLE}."Wal Bratislava";;
}

dimension: Ysi_The_Club {
  type: yesno
  sql: ${TABLE}."Ysi The Club";;
}

dimension: City_market {
  type: yesno
  sql: ${TABLE}."City-market";;
}

dimension: The_Royal_Athena {
  type: yesno
  sql: ${TABLE}."The Royal Athena";;
}
...
dimension: Disney_Mobile {
  type: yesno
  sql: ${TABLE}."Disney Mobile";;
}

dimension: Charlotte_Rental {
  type: yesno
  sql: ${TABLE}."Charlotte Rental";;
}
...
dimension: Office_Max_Offi {
  type: yesno
  sql: ${TABLE}."Office Max Offi";;
}

dimension: Ysi_Riverstock {
  type: yesno
  sql: ${TABLE}."Ysi Riverstock";;
}
...
dimension: Younique_LLC {
  type: yesno
  sql: ${TABLE}."Younique LLC";;
}

dimension: Corinne_Me {
  type: yesno
  sql: ${TABLE}."Corinne Me";;
}

dimension: Budget_Suites {
  type: yesno
  sql: ${TABLE}."Budget Suites";;
}
...
dimension: Performance_Aut {
  type: yesno
  sql: ${TABLE}."Performance Aut";;
}
...
dimension: Creative_Car_Credit {
  type: yesno
  sql: ${TABLE}."Creative Car Credit";;
}
...
dimension: Byrd_Palmer {
  type: yesno
  sql: ${TABLE}."Byrd Palmer";;
}
...
dimension: Diamond_Shoal {
  type: yesno
  sql: ${TABLE}."Diamond Shoal";;
}
...
dimension: Badcock_Home_Furni {
  type: yesno
  sql: ${TABLE}."Badcock Home Furni";;
}

dimension: Foxrentacar {
  type: yesno
  sql: ${TABLE}."Foxrentacar";;
}
...
dimension: Ysi_Greenwycke_Cr {
  type: yesno
  sql: ${TABLE}."Ysi Greenwycke Cr";;
}
...
dimension: Snaptravel_Hotel_Deals {
  type: yesno
  sql: ${TABLE}."Snaptravel Hotel Deals";;
}

dimension: Holiday_Oil {
  type: yesno
  sql: ${TABLE}."Holiday Oil";;
}

dimension: Aafes_hump_Troop {
  type: yesno
  sql: ${TABLE}."Aafes-hump Troop";;
}

dimension: Garrison_Ave {
  type: yesno
  sql: ${TABLE}."Garrison Ave";;
}

dimension: Creme_De_La_Creme {
  type: yesno
  sql: ${TABLE}."Creme De La Creme";;
}

dimension: Pappadeaux_Seafood {
  type: yesno
  sql: ${TABLE}."Pappadeaux Seafood";;
}

dimension: Ysi_Arbor_Lakes {
  type: yesno
  sql: ${TABLE}."Ysi Arbor Lakes";;
}

dimension: Ysi_Vista_Haven {
  type: yesno
  sql: ${TABLE}."Ysi Vista Haven";;
}

dimension: Buildabear_Wrkshp {
  type: yesno
  sql: ${TABLE}."Buildabear Wrkshp";;
}

dimension: Ysi_Ren_Box_Sp_Limited {
  type: yesno
  sql: ${TABLE}."Ysi Ren Box Sp Limited";;
}

dimension: Yoox_Group {
  type: yesno
  sql: ${TABLE}."Yoox Group";;
}

dimension: Intown_zlm {
  type: yesno
  sql: ${TABLE}."Intown-zlm";;
}

dimension: Athenazeusc {
  type: yesno
  sql: ${TABLE}."Athenazeusc";;
}

dimension: Ysi_Kernan_Land_Co {
  type: yesno
  sql: ${TABLE}."Ysi Kernan Land Co";;
}

dimension: Quadpay_Fas {
  type: yesno
  sql: ${TABLE}."Quadpay Fas";;
}
